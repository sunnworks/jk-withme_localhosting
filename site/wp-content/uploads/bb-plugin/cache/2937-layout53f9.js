 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-u0jge1kxw3h9 .pp-heading-separator, .fl-node-u0jge1kxw3h9 .pp-heading').removeClass('pp-left');
        $('.fl-node-u0jge1kxw3h9 .pp-heading-separator, .fl-node-u0jge1kxw3h9 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-u0jge1kxw3h9 .pp-heading-separator, .fl-node-u0jge1kxw3h9 .pp-heading').removeClass('pp-left');
        $('.fl-node-u0jge1kxw3h9 .pp-heading-separator, .fl-node-u0jge1kxw3h9 .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-4kpgx37orihj .fl-photo-img' )
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_79lr0vdyunic'] = new PPAccordion({
			id: '79lr0vdyunic',
			defaultItem: 1,
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-z0wbul4qg68s .pp-heading-separator, .fl-node-z0wbul4qg68s .pp-heading').removeClass('pp-center');
        $('.fl-node-z0wbul4qg68s .pp-heading-separator, .fl-node-z0wbul4qg68s .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-z0wbul4qg68s .pp-heading-separator, .fl-node-z0wbul4qg68s .pp-heading').removeClass('pp-center');
        $('.fl-node-z0wbul4qg68s .pp-heading-separator, .fl-node-z0wbul4qg68s .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-nawtleyf6ipg .pp-heading-separator, .fl-node-nawtleyf6ipg .pp-heading').removeClass('pp-left');
        $('.fl-node-nawtleyf6ipg .pp-heading-separator, .fl-node-nawtleyf6ipg .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-nawtleyf6ipg .pp-heading-separator, .fl-node-nawtleyf6ipg .pp-heading').removeClass('pp-left');
        $('.fl-node-nawtleyf6ipg .pp-heading-separator, .fl-node-nawtleyf6ipg .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-ikjsm7uz6q19 .pp-heading-separator, .fl-node-ikjsm7uz6q19 .pp-heading').removeClass('pp-left');
        $('.fl-node-ikjsm7uz6q19 .pp-heading-separator, .fl-node-ikjsm7uz6q19 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-ikjsm7uz6q19 .pp-heading-separator, .fl-node-ikjsm7uz6q19 .pp-heading').removeClass('pp-left');
        $('.fl-node-ikjsm7uz6q19 .pp-heading-separator, .fl-node-ikjsm7uz6q19 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-bcyvjslxo75p .pp-heading-separator, .fl-node-bcyvjslxo75p .pp-heading').removeClass('pp-left');
        $('.fl-node-bcyvjslxo75p .pp-heading-separator, .fl-node-bcyvjslxo75p .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-bcyvjslxo75p .pp-heading-separator, .fl-node-bcyvjslxo75p .pp-heading').removeClass('pp-left');
        $('.fl-node-bcyvjslxo75p .pp-heading-separator, .fl-node-bcyvjslxo75p .pp-heading').addClass('pp-mobile-left');
    }
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-7ysea1k4to5d .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 120) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 120;
			}
		});
		$('.fl-node-7ysea1k4to5d .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-7ysea1k4to5d .pp-logos-wrapper').imagesLoaded(function() {
			// Clear the controls in case they were already created.
		//$('.fl-node-7ysea1k4to5d .logo-slider-next').empty();
		//$('.fl-node-7ysea1k4to5d .logo-slider-prev').empty();

		var getMinSlides = function() {
			var minSlides = ( $( window ).width() <= 768 ) ? parseInt( $( '.fl-node-7ysea1k4to5d' ).width() / 1140) : 5;
		...
		var totalSlides = $('.fl-node-7ysea1k4to5d .pp-logo:not(.bx-clone)').length;
		...
		var options = {
			...
			onSliderLoad: function() {
				$('.fl-node-7ysea1k4to5d .pp-logos-wrapper').addClass('pp-logos-wrapper-loaded');
				$('.fl-node-7ysea1k4to5d .pp-logo').attr('role', 'group');

				var visibleCount = 0;
				$('.fl-node-7ysea1k4to5d .pp-logo').each(function() {
				...
				$('.fl-node-7ysea1k4to5d').off('keyup').on('keyup', function(e) {
					e.stopPropagation();
				...
				$(document).trigger( 'pp_logos_on_slider_load', [ $('.fl-node-7ysea1k4to5d') ] );
			},
			onSlideBefore: function( ele, oldIndex, newIndex ) {
				this.stopAuto( true );
				$('.fl-node-7ysea1k4to5d .logo-slider-nav').addClass('disabled');
				$('.fl-node-7ysea1k4to5d .bx-controls .bx-pager-link').addClass('disabled');
								this.startAuto( true );
			...
			onSlideAfter: function( ele, oldIndex, newIndex ) {
				$('.fl-node-7ysea1k4to5d .logo-slider-nav').removeClass('disabled');
				$('.fl-node-7ysea1k4to5d .bx-controls .bx-pager-link').removeClass('disabled');
			}
		};
		...
		// Create the slider.
		var slider = $('.fl-node-7ysea1k4to5d .pp-logos-wrapper').bxSlider( options );

		// Store a reference to the slider.
		slider.data('bxSlider', slider);


				$('.fl-node-7ysea1k4to5d .logo-slider-prev').on( 'click', function( e ){
			e.preventDefault();
		...
		$('.fl-node-7ysea1k4to5d .logo-slider-next').on( 'click', function( e ){
			e.preventDefault();
			slider.stopAuto( true );
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-c3go14xd720w .pp-heading-separator, .fl-node-c3go14xd720w .pp-heading').removeClass('pp-');
        $('.fl-node-c3go14xd720w .pp-heading-separator, .fl-node-c3go14xd720w .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-c3go14xd720w .pp-heading-separator, .fl-node-c3go14xd720w .pp-heading').removeClass('pp-');
        $('.fl-node-c3go14xd720w .pp-heading-separator, .fl-node-c3go14xd720w .pp-heading').addClass('pp-mobile-left');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-n9gqkzayx1pw .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-fnkpz1o0q64s .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
