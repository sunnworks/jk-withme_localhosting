...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-59kqa3i4gf8p .fl-photo-img' )
 ...
 */(function($) {
		...
		$('.fl-node-qzechyrx7aki .pp-infobox').on('mouseenter', function() {
		$('.fl-node-qzechyrx7aki .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-qzechyrx7aki .pp-infobox').on('mouseleave', function() {
		$('.fl-node-qzechyrx7aki .pp-icon-wrapper').removeClass(' none');
	});
 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-d5x4v9falick .pp-heading-separator, .fl-node-d5x4v9falick .pp-heading').removeClass('pp-left');
        $('.fl-node-d5x4v9falick .pp-heading-separator, .fl-node-d5x4v9falick .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-d5x4v9falick .pp-heading-separator, .fl-node-d5x4v9falick .pp-heading').removeClass('pp-left');
        $('.fl-node-d5x4v9falick .pp-heading-separator, .fl-node-d5x4v9falick .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-1hefqyovgp9l .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-v79m682ydxr0 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-9zn60jcheilw .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-0jylr48okew9 .pp-heading-separator, .fl-node-0jylr48okew9 .pp-heading').removeClass('pp-left');
        $('.fl-node-0jylr48okew9 .pp-heading-separator, .fl-node-0jylr48okew9 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-0jylr48okew9 .pp-heading-separator, .fl-node-0jylr48okew9 .pp-heading').removeClass('pp-left');
        $('.fl-node-0jylr48okew9 .pp-heading-separator, .fl-node-0jylr48okew9 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-k82ly3x0az57 .pp-heading-separator, .fl-node-k82ly3x0az57 .pp-heading').removeClass('pp-left');
        $('.fl-node-k82ly3x0az57 .pp-heading-separator, .fl-node-k82ly3x0az57 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-k82ly3x0az57 .pp-heading-separator, .fl-node-k82ly3x0az57 .pp-heading').removeClass('pp-left');
        $('.fl-node-k82ly3x0az57 .pp-heading-separator, .fl-node-k82ly3x0az57 .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-dpb9s4lkj1gy .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
