 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-e56os9qdwmz1 .pp-heading-separator, .fl-node-e56os9qdwmz1 .pp-heading').removeClass('pp-left');
        $('.fl-node-e56os9qdwmz1 .pp-heading-separator, .fl-node-e56os9qdwmz1 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-e56os9qdwmz1 .pp-heading-separator, .fl-node-e56os9qdwmz1 .pp-heading').removeClass('pp-left');
        $('.fl-node-e56os9qdwmz1 .pp-heading-separator, .fl-node-e56os9qdwmz1 .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-xbds7mi4013v .fl-photo-img' )
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-aqvi6zrxp2se .pp-heading-separator, .fl-node-aqvi6zrxp2se .pp-heading').removeClass('pp-left');
        $('.fl-node-aqvi6zrxp2se .pp-heading-separator, .fl-node-aqvi6zrxp2se .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-aqvi6zrxp2se .pp-heading-separator, .fl-node-aqvi6zrxp2se .pp-heading').removeClass('pp-left');
        $('.fl-node-aqvi6zrxp2se .pp-heading-separator, .fl-node-aqvi6zrxp2se .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_t6ig0ca19euj'] = new PPAccordion({
			id: 't6ig0ca19euj',
			defaultItem: 1,
...
(function($) {
	...
	$(function() {
		...
		$('.fl-node-msf34pjaek28 .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
		$('.fl-node-msf34pjaek28 .pp-tabs-style-2 .pp-tabs-label').on('click', function() {
			$('.fl-node-msf34pjaek28 .pp-tabs-style-2 .pp-tabs-label').removeClass('pp-no-border');
			$('.fl-node-msf34pjaek28 .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
		});

		if($(window).width() > 768) {
			$('.fl-node-msf34pjaek28 .pp-tabs-vertical .pp-tabs-panel-content').css('min-height', $('.fl-node-msf34pjaek28 .pp-tabs-vertical .pp-tabs-labels').outerHeight() + 'px');
		}

		if( $(window).width() <= 768 ) {
			$('.fl-node-msf34pjaek28 .pp-tabs-label .pp-tab-close').on('click', function() {
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-3xh6zgn9edsp .pp-heading-separator, .fl-node-3xh6zgn9edsp .pp-heading').removeClass('pp-center');
        $('.fl-node-3xh6zgn9edsp .pp-heading-separator, .fl-node-3xh6zgn9edsp .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-3xh6zgn9edsp .pp-heading-separator, .fl-node-3xh6zgn9edsp .pp-heading').removeClass('pp-center');
        $('.fl-node-3xh6zgn9edsp .pp-heading-separator, .fl-node-3xh6zgn9edsp .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-w9irqghxsdb6 .pp-heading-separator, .fl-node-w9irqghxsdb6 .pp-heading').removeClass('pp-left');
        $('.fl-node-w9irqghxsdb6 .pp-heading-separator, .fl-node-w9irqghxsdb6 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-w9irqghxsdb6 .pp-heading-separator, .fl-node-w9irqghxsdb6 .pp-heading').removeClass('pp-left');
        $('.fl-node-w9irqghxsdb6 .pp-heading-separator, .fl-node-w9irqghxsdb6 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-br8ls0hnpgcj .pp-heading-separator, .fl-node-br8ls0hnpgcj .pp-heading').removeClass('pp-left');
        $('.fl-node-br8ls0hnpgcj .pp-heading-separator, .fl-node-br8ls0hnpgcj .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-br8ls0hnpgcj .pp-heading-separator, .fl-node-br8ls0hnpgcj .pp-heading').removeClass('pp-left');
        $('.fl-node-br8ls0hnpgcj .pp-heading-separator, .fl-node-br8ls0hnpgcj .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-ydngqsia7woe .pp-heading-separator, .fl-node-ydngqsia7woe .pp-heading').removeClass('pp-center');
        $('.fl-node-ydngqsia7woe .pp-heading-separator, .fl-node-ydngqsia7woe .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-ydngqsia7woe .pp-heading-separator, .fl-node-ydngqsia7woe .pp-heading').removeClass('pp-center');
        $('.fl-node-ydngqsia7woe .pp-heading-separator, .fl-node-ydngqsia7woe .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-axqnczd9w4yo .pp-heading-separator, .fl-node-axqnczd9w4yo .pp-heading').removeClass('pp-center');
        $('.fl-node-axqnczd9w4yo .pp-heading-separator, .fl-node-axqnczd9w4yo .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-axqnczd9w4yo .pp-heading-separator, .fl-node-axqnczd9w4yo .pp-heading').removeClass('pp-center');
        $('.fl-node-axqnczd9w4yo .pp-heading-separator, .fl-node-axqnczd9w4yo .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-mg18isqeuhtc .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-f5xrumnkl4dz .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-n53uzpkowt97 .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-n53uzpkowt97 .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-n53uzpkowt97 .pp-logos-wrapper').imagesLoaded(function() {
			// Clear the controls in case they were already created.
		//$('.fl-node-n53uzpkowt97 .logo-slider-next').empty();
		//$('.fl-node-n53uzpkowt97 .logo-slider-prev').empty();

		var getMinSlides = function() {
			var minSlides = ( $( window ).width() <= 768 ) ? parseInt( $( '.fl-node-n53uzpkowt97' ).width() / 410) : 5;
		...
		var totalSlides = $('.fl-node-n53uzpkowt97 .pp-logo:not(.bx-clone)').length;
		...
		var options = {
			...
			onSliderLoad: function() {
				$('.fl-node-n53uzpkowt97 .pp-logos-wrapper').addClass('pp-logos-wrapper-loaded');
				$('.fl-node-n53uzpkowt97 .pp-logo').attr('role', 'group');

				var visibleCount = 0;
				$('.fl-node-n53uzpkowt97 .pp-logo').each(function() {
				...
				$('.fl-node-n53uzpkowt97').off('keyup').on('keyup', function(e) {
					e.stopPropagation();
				...
				$(document).trigger( 'pp_logos_on_slider_load', [ $('.fl-node-n53uzpkowt97') ] );
			},
			onSlideBefore: function( ele, oldIndex, newIndex ) {
				this.stopAuto( true );
				$('.fl-node-n53uzpkowt97 .logo-slider-nav').addClass('disabled');
				$('.fl-node-n53uzpkowt97 .bx-controls .bx-pager-link').addClass('disabled');
								this.startAuto( true );
			...
			onSlideAfter: function( ele, oldIndex, newIndex ) {
				$('.fl-node-n53uzpkowt97 .logo-slider-nav').removeClass('disabled');
				$('.fl-node-n53uzpkowt97 .bx-controls .bx-pager-link').removeClass('disabled');
			}
		};
		...
		// Create the slider.
		var slider = $('.fl-node-n53uzpkowt97 .pp-logos-wrapper').bxSlider( options );
