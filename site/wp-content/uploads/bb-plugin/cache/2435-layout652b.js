 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-zo0l6areb485 .pp-heading-separator, .fl-node-zo0l6areb485 .pp-heading').removeClass('pp-center');
        $('.fl-node-zo0l6areb485 .pp-heading-separator, .fl-node-zo0l6areb485 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-zo0l6areb485 .pp-heading-separator, .fl-node-zo0l6areb485 .pp-heading').removeClass('pp-center');
        $('.fl-node-zo0l6areb485 .pp-heading-separator, .fl-node-zo0l6areb485 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-7t306gnsupvz .pp-heading-separator, .fl-node-7t306gnsupvz .pp-heading').removeClass('pp-center');
        $('.fl-node-7t306gnsupvz .pp-heading-separator, .fl-node-7t306gnsupvz .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-7t306gnsupvz .pp-heading-separator, .fl-node-7t306gnsupvz .pp-heading').removeClass('pp-center');
        $('.fl-node-7t306gnsupvz .pp-heading-separator, .fl-node-7t306gnsupvz .pp-heading').addClass('pp-mobile-');
    }
