 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-7dsri3ey5ltz .pp-heading-separator, .fl-node-7dsri3ey5ltz .pp-heading').removeClass('pp-left');
        $('.fl-node-7dsri3ey5ltz .pp-heading-separator, .fl-node-7dsri3ey5ltz .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-7dsri3ey5ltz .pp-heading-separator, .fl-node-7dsri3ey5ltz .pp-heading').removeClass('pp-left');
        $('.fl-node-7dsri3ey5ltz .pp-heading-separator, .fl-node-7dsri3ey5ltz .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-8hpw6n251cfs .fl-photo-img' )
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_1vu4r5qsex6y'] = new PPAccordion({
			id: '1vu4r5qsex6y',
			defaultItem: 1,
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-me1j46kv97sr .pp-heading-separator, .fl-node-me1j46kv97sr .pp-heading').removeClass('pp-center');
        $('.fl-node-me1j46kv97sr .pp-heading-separator, .fl-node-me1j46kv97sr .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-me1j46kv97sr .pp-heading-separator, .fl-node-me1j46kv97sr .pp-heading').removeClass('pp-center');
        $('.fl-node-me1j46kv97sr .pp-heading-separator, .fl-node-me1j46kv97sr .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-f21sygdiu5hz .pp-heading-separator, .fl-node-f21sygdiu5hz .pp-heading').removeClass('pp-left');
        $('.fl-node-f21sygdiu5hz .pp-heading-separator, .fl-node-f21sygdiu5hz .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-f21sygdiu5hz .pp-heading-separator, .fl-node-f21sygdiu5hz .pp-heading').removeClass('pp-left');
        $('.fl-node-f21sygdiu5hz .pp-heading-separator, .fl-node-f21sygdiu5hz .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-9sfykj6t80nu .pp-heading-separator, .fl-node-9sfykj6t80nu .pp-heading').removeClass('pp-left');
        $('.fl-node-9sfykj6t80nu .pp-heading-separator, .fl-node-9sfykj6t80nu .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-9sfykj6t80nu .pp-heading-separator, .fl-node-9sfykj6t80nu .pp-heading').removeClass('pp-left');
        $('.fl-node-9sfykj6t80nu .pp-heading-separator, .fl-node-9sfykj6t80nu .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-e6cp1uxh7s2r .pp-heading-separator, .fl-node-e6cp1uxh7s2r .pp-heading').removeClass('pp-left');
        $('.fl-node-e6cp1uxh7s2r .pp-heading-separator, .fl-node-e6cp1uxh7s2r .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-e6cp1uxh7s2r .pp-heading-separator, .fl-node-e6cp1uxh7s2r .pp-heading').removeClass('pp-left');
        $('.fl-node-e6cp1uxh7s2r .pp-heading-separator, .fl-node-e6cp1uxh7s2r .pp-heading').addClass('pp-mobile-left');
    }
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-6iz3ou087qxm .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 120) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 120;
			}
		});
		$('.fl-node-6iz3ou087qxm .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-6iz3ou087qxm .pp-logos-wrapper').imagesLoaded(function() {
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-nzc1sdkarit3 .pp-heading-separator, .fl-node-nzc1sdkarit3 .pp-heading').removeClass('pp-left');
        $('.fl-node-nzc1sdkarit3 .pp-heading-separator, .fl-node-nzc1sdkarit3 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-nzc1sdkarit3 .pp-heading-separator, .fl-node-nzc1sdkarit3 .pp-heading').removeClass('pp-left');
        $('.fl-node-nzc1sdkarit3 .pp-heading-separator, .fl-node-nzc1sdkarit3 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-4856yq93jmls .pp-heading-separator, .fl-node-4856yq93jmls .pp-heading').removeClass('pp-left');
        $('.fl-node-4856yq93jmls .pp-heading-separator, .fl-node-4856yq93jmls .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-4856yq93jmls .pp-heading-separator, .fl-node-4856yq93jmls .pp-heading').removeClass('pp-left');
        $('.fl-node-4856yq93jmls .pp-heading-separator, .fl-node-4856yq93jmls .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-ed6cntswva4x .pp-heading-separator, .fl-node-ed6cntswva4x .pp-heading').removeClass('pp-left');
        $('.fl-node-ed6cntswva4x .pp-heading-separator, .fl-node-ed6cntswva4x .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-ed6cntswva4x .pp-heading-separator, .fl-node-ed6cntswva4x .pp-heading').removeClass('pp-left');
        $('.fl-node-ed6cntswva4x .pp-heading-separator, .fl-node-ed6cntswva4x .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-hua7pgtojyfe .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-t1vqh9pfa437 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
