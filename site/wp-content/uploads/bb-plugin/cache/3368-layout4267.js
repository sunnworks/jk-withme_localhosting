 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-2791ujrspgyf .pp-heading-separator, .fl-node-2791ujrspgyf .pp-heading').removeClass('pp-left');
        $('.fl-node-2791ujrspgyf .pp-heading-separator, .fl-node-2791ujrspgyf .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-2791ujrspgyf .pp-heading-separator, .fl-node-2791ujrspgyf .pp-heading').removeClass('pp-left');
        $('.fl-node-2791ujrspgyf .pp-heading-separator, .fl-node-2791ujrspgyf .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-jb0al9tockny .fl-photo-img' )
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_tb1sdj42x9w5'] = new PPAccordion({
			id: 'tb1sdj42x9w5',
			defaultItem: 1,
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-k76zrfatguyd .pp-heading-separator, .fl-node-k76zrfatguyd .pp-heading').removeClass('pp-left');
        $('.fl-node-k76zrfatguyd .pp-heading-separator, .fl-node-k76zrfatguyd .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-k76zrfatguyd .pp-heading-separator, .fl-node-k76zrfatguyd .pp-heading').removeClass('pp-left');
        $('.fl-node-k76zrfatguyd .pp-heading-separator, .fl-node-k76zrfatguyd .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-t1c3aeq6fov0 .pp-heading-separator, .fl-node-t1c3aeq6fov0 .pp-heading').removeClass('pp-center');
        $('.fl-node-t1c3aeq6fov0 .pp-heading-separator, .fl-node-t1c3aeq6fov0 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-t1c3aeq6fov0 .pp-heading-separator, .fl-node-t1c3aeq6fov0 .pp-heading').removeClass('pp-center');
        $('.fl-node-t1c3aeq6fov0 .pp-heading-separator, .fl-node-t1c3aeq6fov0 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-miezvjs15a6o .pp-heading-separator, .fl-node-miezvjs15a6o .pp-heading').removeClass('pp-left');
        $('.fl-node-miezvjs15a6o .pp-heading-separator, .fl-node-miezvjs15a6o .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-miezvjs15a6o .pp-heading-separator, .fl-node-miezvjs15a6o .pp-heading').removeClass('pp-left');
        $('.fl-node-miezvjs15a6o .pp-heading-separator, .fl-node-miezvjs15a6o .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-eyd6qzo8axh5 .pp-heading-separator, .fl-node-eyd6qzo8axh5 .pp-heading').removeClass('pp-left');
        $('.fl-node-eyd6qzo8axh5 .pp-heading-separator, .fl-node-eyd6qzo8axh5 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-eyd6qzo8axh5 .pp-heading-separator, .fl-node-eyd6qzo8axh5 .pp-heading').removeClass('pp-left');
        $('.fl-node-eyd6qzo8axh5 .pp-heading-separator, .fl-node-eyd6qzo8axh5 .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-pybwzxr4suok .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-b7m9l3j0f8qo .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-in6q2rvmxd4s .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-edgzjboy4mwc .pp-heading-separator, .fl-node-edgzjboy4mwc .pp-heading').removeClass('pp-left');
        $('.fl-node-edgzjboy4mwc .pp-heading-separator, .fl-node-edgzjboy4mwc .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-edgzjboy4mwc .pp-heading-separator, .fl-node-edgzjboy4mwc .pp-heading').removeClass('pp-left');
        $('.fl-node-edgzjboy4mwc .pp-heading-separator, .fl-node-edgzjboy4mwc .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-20cofa3s4umx .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-20cofa3s4umx .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-20cofa3s4umx .pp-logos-wrapper').imagesLoaded(function() {
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-2uyavscrketf .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
