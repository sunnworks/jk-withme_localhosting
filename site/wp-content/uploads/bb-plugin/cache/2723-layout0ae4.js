 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-e05fk4nmxuvl .pp-heading-separator, .fl-node-e05fk4nmxuvl .pp-heading').removeClass('pp-left');
        $('.fl-node-e05fk4nmxuvl .pp-heading-separator, .fl-node-e05fk4nmxuvl .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-e05fk4nmxuvl .pp-heading-separator, .fl-node-e05fk4nmxuvl .pp-heading').removeClass('pp-left');
        $('.fl-node-e05fk4nmxuvl .pp-heading-separator, .fl-node-e05fk4nmxuvl .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-1ykrqz50xo7e .fl-photo-img' )
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-e5u0oh8qayl6 .pp-heading-separator, .fl-node-e5u0oh8qayl6 .pp-heading').removeClass('pp-left');
        $('.fl-node-e5u0oh8qayl6 .pp-heading-separator, .fl-node-e5u0oh8qayl6 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-e5u0oh8qayl6 .pp-heading-separator, .fl-node-e5u0oh8qayl6 .pp-heading').removeClass('pp-left');
        $('.fl-node-e5u0oh8qayl6 .pp-heading-separator, .fl-node-e5u0oh8qayl6 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_vl74zqy5ruwd'] = new PPAccordion({
			id: 'vl74zqy5ruwd',
			defaultItem: 1,
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-vkndrhoc6gzl .pp-heading-separator, .fl-node-vkndrhoc6gzl .pp-heading').removeClass('pp-center');
        $('.fl-node-vkndrhoc6gzl .pp-heading-separator, .fl-node-vkndrhoc6gzl .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-vkndrhoc6gzl .pp-heading-separator, .fl-node-vkndrhoc6gzl .pp-heading').removeClass('pp-center');
        $('.fl-node-vkndrhoc6gzl .pp-heading-separator, .fl-node-vkndrhoc6gzl .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-264co38unwrf .pp-heading-separator, .fl-node-264co38unwrf .pp-heading').removeClass('pp-left');
        $('.fl-node-264co38unwrf .pp-heading-separator, .fl-node-264co38unwrf .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-264co38unwrf .pp-heading-separator, .fl-node-264co38unwrf .pp-heading').removeClass('pp-left');
        $('.fl-node-264co38unwrf .pp-heading-separator, .fl-node-264co38unwrf .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-z8uxqsf5gw7t .pp-heading-separator, .fl-node-z8uxqsf5gw7t .pp-heading').removeClass('pp-left');
        $('.fl-node-z8uxqsf5gw7t .pp-heading-separator, .fl-node-z8uxqsf5gw7t .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-z8uxqsf5gw7t .pp-heading-separator, .fl-node-z8uxqsf5gw7t .pp-heading').removeClass('pp-left');
        $('.fl-node-z8uxqsf5gw7t .pp-heading-separator, .fl-node-z8uxqsf5gw7t .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-6qd9gb401h2t .pp-heading-separator, .fl-node-6qd9gb401h2t .pp-heading').removeClass('pp-center');
        $('.fl-node-6qd9gb401h2t .pp-heading-separator, .fl-node-6qd9gb401h2t .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-6qd9gb401h2t .pp-heading-separator, .fl-node-6qd9gb401h2t .pp-heading').removeClass('pp-center');
        $('.fl-node-6qd9gb401h2t .pp-heading-separator, .fl-node-6qd9gb401h2t .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-vbkjlopd39a0 .pp-heading-separator, .fl-node-vbkjlopd39a0 .pp-heading').removeClass('pp-left');
        $('.fl-node-vbkjlopd39a0 .pp-heading-separator, .fl-node-vbkjlopd39a0 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-vbkjlopd39a0 .pp-heading-separator, .fl-node-vbkjlopd39a0 .pp-heading').removeClass('pp-left');
        $('.fl-node-vbkjlopd39a0 .pp-heading-separator, .fl-node-vbkjlopd39a0 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-n4gu7o0abyjx .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-n4gu7o0abyjx .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-n4gu7o0abyjx .pp-logos-wrapper').imagesLoaded(function() {
			// Clear the controls in case they were already created.
		//$('.fl-node-n4gu7o0abyjx .logo-slider-next').empty();
		//$('.fl-node-n4gu7o0abyjx .logo-slider-prev').empty();

		var getMinSlides = function() {
			var minSlides = ( $( window ).width() <= 768 ) ? parseInt( $( '.fl-node-n4gu7o0abyjx' ).width() / 270) : 3;
		...
		var totalSlides = $('.fl-node-n4gu7o0abyjx .pp-logo:not(.bx-clone)').length;
		...
		var options = {
			...
			onSliderLoad: function() {
				$('.fl-node-n4gu7o0abyjx .pp-logos-wrapper').addClass('pp-logos-wrapper-loaded');
				$('.fl-node-n4gu7o0abyjx .pp-logo').attr('role', 'group');

				var visibleCount = 0;
				$('.fl-node-n4gu7o0abyjx .pp-logo').each(function() {
				...
				$('.fl-node-n4gu7o0abyjx').off('keyup').on('keyup', function(e) {
					e.stopPropagation();
				...
				$(document).trigger( 'pp_logos_on_slider_load', [ $('.fl-node-n4gu7o0abyjx') ] );
			},
			onSlideBefore: function( ele, oldIndex, newIndex ) {
				this.stopAuto( true );
				$('.fl-node-n4gu7o0abyjx .logo-slider-nav').addClass('disabled');
				$('.fl-node-n4gu7o0abyjx .bx-controls .bx-pager-link').addClass('disabled');
								this.startAuto( true );
			...
			onSlideAfter: function( ele, oldIndex, newIndex ) {
				$('.fl-node-n4gu7o0abyjx .logo-slider-nav').removeClass('disabled');
				$('.fl-node-n4gu7o0abyjx .bx-controls .bx-pager-link').removeClass('disabled');
			}
		};
		...
		// Create the slider.
		var slider = $('.fl-node-n4gu7o0abyjx .pp-logos-wrapper').bxSlider( options );
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-mg8n9lwbf4vk .pp-heading-separator, .fl-node-mg8n9lwbf4vk .pp-heading').removeClass('pp-center');
        $('.fl-node-mg8n9lwbf4vk .pp-heading-separator, .fl-node-mg8n9lwbf4vk .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-mg8n9lwbf4vk .pp-heading-separator, .fl-node-mg8n9lwbf4vk .pp-heading').removeClass('pp-center');
        $('.fl-node-mg8n9lwbf4vk .pp-heading-separator, .fl-node-mg8n9lwbf4vk .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-4yid90nksclb .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-nisju6hap51z .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-d2w10xqgm48z .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-d2w10xqgm48z .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-d2w10xqgm48z .pp-logos-wrapper').imagesLoaded(function() {
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-rojy73tu81qf .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-rojy73tu81qf .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-rojy73tu81qf .pp-logos-wrapper').imagesLoaded(function() {
			// Clear the controls in case they were already created.
		//$('.fl-node-rojy73tu81qf .logo-slider-next').empty();
		//$('.fl-node-rojy73tu81qf .logo-slider-prev').empty();

		var getMinSlides = function() {
			var minSlides = ( $( window ).width() <= 768 ) ? parseInt( $( '.fl-node-rojy73tu81qf' ).width() / 410) : 5;
		...
		var totalSlides = $('.fl-node-rojy73tu81qf .pp-logo:not(.bx-clone)').length;
		...
		var options = {
			...
			ariaLive: false,
			onSliderLoad: function() {
				$('.fl-node-rojy73tu81qf .pp-logos-wrapper').addClass('pp-logos-wrapper-loaded');
				$('.fl-node-rojy73tu81qf .pp-logo').attr('role', 'group');

				var visibleCount = 0;
				$('.fl-node-rojy73tu81qf .pp-logo').each(function() {
					if ( ! $(this).hasClass( 'bx-clone' ) ) {
						visibleCount++;
						$(this).attr('aria-label', 'Slide ' + visibleCount + ' of ' + totalSlides );
					}
				...
				// Fix keyboard navigation
				var hasItemFocus = false;
				$('.fl-node-rojy73tu81qf').off('keyup').on('keyup', function(e) {
					e.stopPropagation();
					if ( $(e.target).hasClass('pp-logos-wrapper') || $(e.target).closest('.pp-logos-wrapper').length ) {
						hasItemFocus = true;
					}
				...
				$(document).trigger( 'pp_logos_on_slider_load', [ $('.fl-node-rojy73tu81qf') ] );
			},
			onSlideBefore: function( ele, oldIndex, newIndex ) {
				this.stopAuto( true );
				$('.fl-node-rojy73tu81qf .logo-slider-nav').addClass('disabled');
				$('.fl-node-rojy73tu81qf .bx-controls .bx-pager-link').addClass('disabled');
								this.startAuto( true );
			...
			onSlideAfter: function( ele, oldIndex, newIndex ) {
				$('.fl-node-rojy73tu81qf .logo-slider-nav').removeClass('disabled');
				$('.fl-node-rojy73tu81qf .bx-controls .bx-pager-link').removeClass('disabled');
			}
		};
		...
		// Create the slider.
		var slider = $('.fl-node-rojy73tu81qf .pp-logos-wrapper').bxSlider( options );
