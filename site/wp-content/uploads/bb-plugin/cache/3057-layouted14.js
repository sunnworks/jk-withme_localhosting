 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-9qincrgap0uf .pp-heading-separator, .fl-node-9qincrgap0uf .pp-heading').removeClass('pp-left');
        $('.fl-node-9qincrgap0uf .pp-heading-separator, .fl-node-9qincrgap0uf .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-9qincrgap0uf .pp-heading-separator, .fl-node-9qincrgap0uf .pp-heading').removeClass('pp-left');
        $('.fl-node-9qincrgap0uf .pp-heading-separator, .fl-node-9qincrgap0uf .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-q5ib1mnpsjfo .fl-photo-img' )
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-k845nbhfueo9 .pp-heading-separator, .fl-node-k845nbhfueo9 .pp-heading').removeClass('pp-left');
        $('.fl-node-k845nbhfueo9 .pp-heading-separator, .fl-node-k845nbhfueo9 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-k845nbhfueo9 .pp-heading-separator, .fl-node-k845nbhfueo9 .pp-heading').removeClass('pp-left');
        $('.fl-node-k845nbhfueo9 .pp-heading-separator, .fl-node-k845nbhfueo9 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_cjdu6381iqbo'] = new PPAccordion({
			id: 'cjdu6381iqbo',
			defaultItem: 1,
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-0lafx3n5i9qd .pp-heading-separator, .fl-node-0lafx3n5i9qd .pp-heading').removeClass('pp-center');
        $('.fl-node-0lafx3n5i9qd .pp-heading-separator, .fl-node-0lafx3n5i9qd .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-0lafx3n5i9qd .pp-heading-separator, .fl-node-0lafx3n5i9qd .pp-heading').removeClass('pp-center');
        $('.fl-node-0lafx3n5i9qd .pp-heading-separator, .fl-node-0lafx3n5i9qd .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-b18f3gdx7puc .pp-heading-separator, .fl-node-b18f3gdx7puc .pp-heading').removeClass('pp-left');
        $('.fl-node-b18f3gdx7puc .pp-heading-separator, .fl-node-b18f3gdx7puc .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-b18f3gdx7puc .pp-heading-separator, .fl-node-b18f3gdx7puc .pp-heading').removeClass('pp-left');
        $('.fl-node-b18f3gdx7puc .pp-heading-separator, .fl-node-b18f3gdx7puc .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-h504ek6dom91 .pp-heading-separator, .fl-node-h504ek6dom91 .pp-heading').removeClass('pp-left');
        $('.fl-node-h504ek6dom91 .pp-heading-separator, .fl-node-h504ek6dom91 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-h504ek6dom91 .pp-heading-separator, .fl-node-h504ek6dom91 .pp-heading').removeClass('pp-left');
        $('.fl-node-h504ek6dom91 .pp-heading-separator, .fl-node-h504ek6dom91 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-csrgfx70oy98 .pp-heading-separator, .fl-node-csrgfx70oy98 .pp-heading').removeClass('pp-left');
        $('.fl-node-csrgfx70oy98 .pp-heading-separator, .fl-node-csrgfx70oy98 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-csrgfx70oy98 .pp-heading-separator, .fl-node-csrgfx70oy98 .pp-heading').removeClass('pp-left');
        $('.fl-node-csrgfx70oy98 .pp-heading-separator, .fl-node-csrgfx70oy98 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	$(function() {
		...
		$('.fl-node-eg0fti8k6u23 .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
		$('.fl-node-eg0fti8k6u23 .pp-tabs-style-2 .pp-tabs-label').on('click', function() {
			$('.fl-node-eg0fti8k6u23 .pp-tabs-style-2 .pp-tabs-label').removeClass('pp-no-border');
			$('.fl-node-eg0fti8k6u23 .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
		});

		if($(window).width() > 768) {
			$('.fl-node-eg0fti8k6u23 .pp-tabs-vertical .pp-tabs-panel-content').css('min-height', $('.fl-node-eg0fti8k6u23 .pp-tabs-vertical .pp-tabs-labels').outerHeight() + 'px');
		}

		if( $(window).width() <= 768 ) {
			$('.fl-node-eg0fti8k6u23 .pp-tabs-label .pp-tab-close').on('click', function() {
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-o1j9us73nb5c .pp-heading-separator, .fl-node-o1j9us73nb5c .pp-heading').removeClass('pp-left');
        $('.fl-node-o1j9us73nb5c .pp-heading-separator, .fl-node-o1j9us73nb5c .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-o1j9us73nb5c .pp-heading-separator, .fl-node-o1j9us73nb5c .pp-heading').removeClass('pp-left');
        $('.fl-node-o1j9us73nb5c .pp-heading-separator, .fl-node-o1j9us73nb5c .pp-heading').addClass('pp-mobile-left');
    }
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-uzecw6ajvdl7 .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 120) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 120;
			}
		});
		$('.fl-node-uzecw6ajvdl7 .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-uzecw6ajvdl7 .pp-logos-wrapper').imagesLoaded(function() {
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-unwsch8d2e9b .pp-heading-separator, .fl-node-unwsch8d2e9b .pp-heading').removeClass('pp-center');
        $('.fl-node-unwsch8d2e9b .pp-heading-separator, .fl-node-unwsch8d2e9b .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-unwsch8d2e9b .pp-heading-separator, .fl-node-unwsch8d2e9b .pp-heading').removeClass('pp-center');
        $('.fl-node-unwsch8d2e9b .pp-heading-separator, .fl-node-unwsch8d2e9b .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-ybdt3zgrwlm7 .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-ybdt3zgrwlm7 .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-ybdt3zgrwlm7 .pp-logos-wrapper').imagesLoaded(function() {
			// Clear the controls in case they were already created.
		//$('.fl-node-ybdt3zgrwlm7 .logo-slider-next').empty();
		//$('.fl-node-ybdt3zgrwlm7 .logo-slider-prev').empty();

		var getMinSlides = function() {
			var minSlides = ( $( window ).width() <= 768 ) ? parseInt( $( '.fl-node-ybdt3zgrwlm7' ).width() / 410) : 5;
		...
		var totalSlides = $('.fl-node-ybdt3zgrwlm7 .pp-logo:not(.bx-clone)').length;
		...
		var options = {
			...
			onSliderLoad: function() {
				$('.fl-node-ybdt3zgrwlm7 .pp-logos-wrapper').addClass('pp-logos-wrapper-loaded');
				$('.fl-node-ybdt3zgrwlm7 .pp-logo').attr('role', 'group');

				var visibleCount = 0;
				$('.fl-node-ybdt3zgrwlm7 .pp-logo').each(function() {
				...
				$('.fl-node-ybdt3zgrwlm7').off('keyup').on('keyup', function(e) {
					e.stopPropagation();
				...
				$(document).trigger( 'pp_logos_on_slider_load', [ $('.fl-node-ybdt3zgrwlm7') ] );
			},
			onSlideBefore: function( ele, oldIndex, newIndex ) {
				this.stopAuto( true );
				$('.fl-node-ybdt3zgrwlm7 .logo-slider-nav').addClass('disabled');
				$('.fl-node-ybdt3zgrwlm7 .bx-controls .bx-pager-link').addClass('disabled');
								this.startAuto( true );
			...
			onSlideAfter: function( ele, oldIndex, newIndex ) {
				$('.fl-node-ybdt3zgrwlm7 .logo-slider-nav').removeClass('disabled');
				$('.fl-node-ybdt3zgrwlm7 .bx-controls .bx-pager-link').removeClass('disabled');
			}
		};
		...
		// Create the slider.
		var slider = $('.fl-node-ybdt3zgrwlm7 .pp-logos-wrapper').bxSlider( options );
