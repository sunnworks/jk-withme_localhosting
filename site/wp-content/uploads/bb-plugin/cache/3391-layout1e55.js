 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-2pvxt04jkmfy .pp-heading-separator, .fl-node-2pvxt04jkmfy .pp-heading').removeClass('pp-left');
        $('.fl-node-2pvxt04jkmfy .pp-heading-separator, .fl-node-2pvxt04jkmfy .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-2pvxt04jkmfy .pp-heading-separator, .fl-node-2pvxt04jkmfy .pp-heading').removeClass('pp-left');
        $('.fl-node-2pvxt04jkmfy .pp-heading-separator, .fl-node-2pvxt04jkmfy .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-crfbj2x09m5k .fl-photo-img' )
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_mhf1g6ewzvoc'] = new PPAccordion({
			id: 'mhf1g6ewzvoc',
			defaultItem: 1,
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-ns29cwrti7yj .pp-heading-separator, .fl-node-ns29cwrti7yj .pp-heading').removeClass('pp-left');
        $('.fl-node-ns29cwrti7yj .pp-heading-separator, .fl-node-ns29cwrti7yj .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-ns29cwrti7yj .pp-heading-separator, .fl-node-ns29cwrti7yj .pp-heading').removeClass('pp-left');
        $('.fl-node-ns29cwrti7yj .pp-heading-separator, .fl-node-ns29cwrti7yj .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-k613xb0qt4h9 .pp-heading-separator, .fl-node-k613xb0qt4h9 .pp-heading').removeClass('pp-center');
        $('.fl-node-k613xb0qt4h9 .pp-heading-separator, .fl-node-k613xb0qt4h9 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-k613xb0qt4h9 .pp-heading-separator, .fl-node-k613xb0qt4h9 .pp-heading').removeClass('pp-center');
        $('.fl-node-k613xb0qt4h9 .pp-heading-separator, .fl-node-k613xb0qt4h9 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-53hygc617tzq .pp-heading-separator, .fl-node-53hygc617tzq .pp-heading').removeClass('pp-left');
        $('.fl-node-53hygc617tzq .pp-heading-separator, .fl-node-53hygc617tzq .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-53hygc617tzq .pp-heading-separator, .fl-node-53hygc617tzq .pp-heading').removeClass('pp-left');
        $('.fl-node-53hygc617tzq .pp-heading-separator, .fl-node-53hygc617tzq .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-75xil18cen0m .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-zwbcu0o2fxhk .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-y0n6uolxf58q .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-pnhs0q5r2b8x .pp-heading-separator, .fl-node-pnhs0q5r2b8x .pp-heading').removeClass('pp-left');
        $('.fl-node-pnhs0q5r2b8x .pp-heading-separator, .fl-node-pnhs0q5r2b8x .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-pnhs0q5r2b8x .pp-heading-separator, .fl-node-pnhs0q5r2b8x .pp-heading').removeClass('pp-left');
        $('.fl-node-pnhs0q5r2b8x .pp-heading-separator, .fl-node-pnhs0q5r2b8x .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-btskj9zl7ndy .pp-heading-separator, .fl-node-btskj9zl7ndy .pp-heading').removeClass('pp-left');
        $('.fl-node-btskj9zl7ndy .pp-heading-separator, .fl-node-btskj9zl7ndy .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-btskj9zl7ndy .pp-heading-separator, .fl-node-btskj9zl7ndy .pp-heading').removeClass('pp-left');
        $('.fl-node-btskj9zl7ndy .pp-heading-separator, .fl-node-btskj9zl7ndy .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-8t5awiqrb2np .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-34o6tld91snr .pp-heading-separator, .fl-node-34o6tld91snr .pp-heading').removeClass('pp-center');
        $('.fl-node-34o6tld91snr .pp-heading-separator, .fl-node-34o6tld91snr .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-34o6tld91snr .pp-heading-separator, .fl-node-34o6tld91snr .pp-heading').removeClass('pp-center');
        $('.fl-node-34o6tld91snr .pp-heading-separator, .fl-node-34o6tld91snr .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-r95jcqm20sz8 .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-r95jcqm20sz8 .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-r95jcqm20sz8 .pp-logos-wrapper').imagesLoaded(function() {
			// Clear the controls in case they were already created.
		//$('.fl-node-r95jcqm20sz8 .logo-slider-next').empty();
		//$('.fl-node-r95jcqm20sz8 .logo-slider-prev').empty();

		var getMinSlides = function() {
			var minSlides = ( $( window ).width() <= 768 ) ? parseInt( $( '.fl-node-r95jcqm20sz8' ).width() / 410) : 5;
		...
		var totalSlides = $('.fl-node-r95jcqm20sz8 .pp-logo:not(.bx-clone)').length;
		...
		var options = {
			...
			onSliderLoad: function() {
				$('.fl-node-r95jcqm20sz8 .pp-logos-wrapper').addClass('pp-logos-wrapper-loaded');
				$('.fl-node-r95jcqm20sz8 .pp-logo').attr('role', 'group');

				var visibleCount = 0;
				$('.fl-node-r95jcqm20sz8 .pp-logo').each(function() {
				...
				$('.fl-node-r95jcqm20sz8').off('keyup').on('keyup', function(e) {
					e.stopPropagation();
				...
				$(document).trigger( 'pp_logos_on_slider_load', [ $('.fl-node-r95jcqm20sz8') ] );
			},
			onSlideBefore: function( ele, oldIndex, newIndex ) {
				this.stopAuto( true );
				$('.fl-node-r95jcqm20sz8 .logo-slider-nav').addClass('disabled');
				$('.fl-node-r95jcqm20sz8 .bx-controls .bx-pager-link').addClass('disabled');
								this.startAuto( true );
			...
			onSlideAfter: function( ele, oldIndex, newIndex ) {
				$('.fl-node-r95jcqm20sz8 .logo-slider-nav').removeClass('disabled');
				$('.fl-node-r95jcqm20sz8 .bx-controls .bx-pager-link').removeClass('disabled');
			}
		};
		...
		// Create the slider.
		var slider = $('.fl-node-r95jcqm20sz8 .pp-logos-wrapper').bxSlider( options );
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-wxicq5b37gn1 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
