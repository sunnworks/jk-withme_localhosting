...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-io6d2j0r7qfx .fl-photo-img' )
 ...
 */(function($) {
		...
		$('.fl-node-w4p2ef5xj8ha .pp-infobox').on('mouseenter', function() {
		$('.fl-node-w4p2ef5xj8ha .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-w4p2ef5xj8ha .pp-infobox').on('mouseleave', function() {
		$('.fl-node-w4p2ef5xj8ha .pp-icon-wrapper').removeClass(' none');
	});
...
(function($) {
		...
		$('.fl-node-p8by5q0k9xef .pp-infobox').on('mouseenter', function() {
		$('.fl-node-p8by5q0k9xef .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-p8by5q0k9xef .pp-infobox').on('mouseleave', function() {
		$('.fl-node-p8by5q0k9xef .pp-icon-wrapper').removeClass(' none');
	});

})(jQuery);
(function($) {

		$('.fl-node-kahvc4f2yqu5 .pp-infobox').on('mouseenter', function() {
		$('.fl-node-kahvc4f2yqu5 .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-kahvc4f2yqu5 .pp-infobox').on('mouseleave', function() {
		$('.fl-node-kahvc4f2yqu5 .pp-icon-wrapper').removeClass(' none');
	});
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-9r4xk87ts5n1 .pp-heading-separator, .fl-node-9r4xk87ts5n1 .pp-heading').removeClass('pp-left');
        $('.fl-node-9r4xk87ts5n1 .pp-heading-separator, .fl-node-9r4xk87ts5n1 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-9r4xk87ts5n1 .pp-heading-separator, .fl-node-9r4xk87ts5n1 .pp-heading').removeClass('pp-left');
        $('.fl-node-9r4xk87ts5n1 .pp-heading-separator, .fl-node-9r4xk87ts5n1 .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-exuvia83l7qw .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-k98dpgx4tver .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-vy3186h0k5xr .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
