...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-befv59q6zku8 .fl-photo-img' )
 ...
 */(function($) {
		...
		$('.fl-node-bp4xfznhl2e6 .pp-infobox').on('mouseenter', function() {
		$('.fl-node-bp4xfznhl2e6 .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-bp4xfznhl2e6 .pp-infobox').on('mouseleave', function() {
		$('.fl-node-bp4xfznhl2e6 .pp-icon-wrapper').removeClass(' none');
	});
...
(function($) {
		...
		$('.fl-node-m2xhqo30pafs .pp-infobox').on('mouseenter', function() {
		$('.fl-node-m2xhqo30pafs .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-m2xhqo30pafs .pp-infobox').on('mouseleave', function() {
		$('.fl-node-m2xhqo30pafs .pp-icon-wrapper').removeClass(' none');
	});

})(jQuery);
(function($) {

		$('.fl-node-ymf2v751rotb .pp-infobox').on('mouseenter', function() {
		$('.fl-node-ymf2v751rotb .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-ymf2v751rotb .pp-infobox').on('mouseleave', function() {
		$('.fl-node-ymf2v751rotb .pp-icon-wrapper').removeClass(' none');
	});
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-sy8qlr5aoxjk .pp-heading-separator, .fl-node-sy8qlr5aoxjk .pp-heading').removeClass('pp-left');
        $('.fl-node-sy8qlr5aoxjk .pp-heading-separator, .fl-node-sy8qlr5aoxjk .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-sy8qlr5aoxjk .pp-heading-separator, .fl-node-sy8qlr5aoxjk .pp-heading').removeClass('pp-left');
        $('.fl-node-sy8qlr5aoxjk .pp-heading-separator, .fl-node-sy8qlr5aoxjk .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-vypdz2r1exu7 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-8a4v6zoh1tgx .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-rsz1ympkvn7f .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-vx25jtgprhdn .pp-heading-separator, .fl-node-vx25jtgprhdn .pp-heading').removeClass('pp-left');
        $('.fl-node-vx25jtgprhdn .pp-heading-separator, .fl-node-vx25jtgprhdn .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-vx25jtgprhdn .pp-heading-separator, .fl-node-vx25jtgprhdn .pp-heading').removeClass('pp-left');
        $('.fl-node-vx25jtgprhdn .pp-heading-separator, .fl-node-vx25jtgprhdn .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-t1wdgibf9zus .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-pbc37sdngrj8 .pp-heading-separator, .fl-node-pbc37sdngrj8 .pp-heading').removeClass('pp-left');
        $('.fl-node-pbc37sdngrj8 .pp-heading-separator, .fl-node-pbc37sdngrj8 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-pbc37sdngrj8 .pp-heading-separator, .fl-node-pbc37sdngrj8 .pp-heading').removeClass('pp-left');
        $('.fl-node-pbc37sdngrj8 .pp-heading-separator, .fl-node-pbc37sdngrj8 .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-9d83yc0bqu4v .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
