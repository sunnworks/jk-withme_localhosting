 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-qo5gnehdcmux .pp-heading-separator, .fl-node-qo5gnehdcmux .pp-heading').removeClass('pp-left');
        $('.fl-node-qo5gnehdcmux .pp-heading-separator, .fl-node-qo5gnehdcmux .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-qo5gnehdcmux .pp-heading-separator, .fl-node-qo5gnehdcmux .pp-heading').removeClass('pp-left');
        $('.fl-node-qo5gnehdcmux .pp-heading-separator, .fl-node-qo5gnehdcmux .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-mfqex0rkh5j8 .fl-photo-img' )
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-u3lfmje8ntxw .pp-heading-separator, .fl-node-u3lfmje8ntxw .pp-heading').removeClass('pp-left');
        $('.fl-node-u3lfmje8ntxw .pp-heading-separator, .fl-node-u3lfmje8ntxw .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-u3lfmje8ntxw .pp-heading-separator, .fl-node-u3lfmje8ntxw .pp-heading').removeClass('pp-left');
        $('.fl-node-u3lfmje8ntxw .pp-heading-separator, .fl-node-u3lfmje8ntxw .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_5qp7gflaru0n'] = new PPAccordion({
			id: '5qp7gflaru0n',
			defaultItem: 1,
...
(function($) {
	...
	$(function() {
		...
		$('.fl-node-r8hiek2jnyf7 .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
		$('.fl-node-r8hiek2jnyf7 .pp-tabs-style-2 .pp-tabs-label').on('click', function() {
			$('.fl-node-r8hiek2jnyf7 .pp-tabs-style-2 .pp-tabs-label').removeClass('pp-no-border');
			$('.fl-node-r8hiek2jnyf7 .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
		});

		if($(window).width() > 768) {
			$('.fl-node-r8hiek2jnyf7 .pp-tabs-vertical .pp-tabs-panel-content').css('min-height', $('.fl-node-r8hiek2jnyf7 .pp-tabs-vertical .pp-tabs-labels').outerHeight() + 'px');
		}

		if( $(window).width() <= 768 ) {
			$('.fl-node-r8hiek2jnyf7 .pp-tabs-label .pp-tab-close').on('click', function() {
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-h28i3olsajpr .pp-heading-separator, .fl-node-h28i3olsajpr .pp-heading').removeClass('pp-center');
        $('.fl-node-h28i3olsajpr .pp-heading-separator, .fl-node-h28i3olsajpr .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-h28i3olsajpr .pp-heading-separator, .fl-node-h28i3olsajpr .pp-heading').removeClass('pp-center');
        $('.fl-node-h28i3olsajpr .pp-heading-separator, .fl-node-h28i3olsajpr .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-3q8f2predx9m .pp-heading-separator, .fl-node-3q8f2predx9m .pp-heading').removeClass('pp-left');
        $('.fl-node-3q8f2predx9m .pp-heading-separator, .fl-node-3q8f2predx9m .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-3q8f2predx9m .pp-heading-separator, .fl-node-3q8f2predx9m .pp-heading').removeClass('pp-left');
        $('.fl-node-3q8f2predx9m .pp-heading-separator, .fl-node-3q8f2predx9m .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-5kq4np1vgawc .pp-heading-separator, .fl-node-5kq4np1vgawc .pp-heading').removeClass('pp-left');
        $('.fl-node-5kq4np1vgawc .pp-heading-separator, .fl-node-5kq4np1vgawc .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-5kq4np1vgawc .pp-heading-separator, .fl-node-5kq4np1vgawc .pp-heading').removeClass('pp-left');
        $('.fl-node-5kq4np1vgawc .pp-heading-separator, .fl-node-5kq4np1vgawc .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-t47czf5a1snu .pp-heading-separator, .fl-node-t47czf5a1snu .pp-heading').removeClass('pp-center');
        $('.fl-node-t47czf5a1snu .pp-heading-separator, .fl-node-t47czf5a1snu .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-t47czf5a1snu .pp-heading-separator, .fl-node-t47czf5a1snu .pp-heading').removeClass('pp-center');
        $('.fl-node-t47czf5a1snu .pp-heading-separator, .fl-node-t47czf5a1snu .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-zcjxf5ht4kp0 .pp-heading-separator, .fl-node-zcjxf5ht4kp0 .pp-heading').removeClass('pp-center');
        $('.fl-node-zcjxf5ht4kp0 .pp-heading-separator, .fl-node-zcjxf5ht4kp0 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-zcjxf5ht4kp0 .pp-heading-separator, .fl-node-zcjxf5ht4kp0 .pp-heading').removeClass('pp-center');
        $('.fl-node-zcjxf5ht4kp0 .pp-heading-separator, .fl-node-zcjxf5ht4kp0 .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-3jkxf25tbql7 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-90tajl4wp2md .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-yhjb4gmel9dq .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-yhjb4gmel9dq .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-yhjb4gmel9dq .pp-logos-wrapper').imagesLoaded(function() {
			// Clear the controls in case they were already created.
		//$('.fl-node-yhjb4gmel9dq .logo-slider-next').empty();
		//$('.fl-node-yhjb4gmel9dq .logo-slider-prev').empty();

		var getMinSlides = function() {
			var minSlides = ( $( window ).width() <= 768 ) ? parseInt( $( '.fl-node-yhjb4gmel9dq' ).width() / 410) : 5;
		...
		var totalSlides = $('.fl-node-yhjb4gmel9dq .pp-logo:not(.bx-clone)').length;
		...
		var options = {
			...
			onSliderLoad: function() {
				$('.fl-node-yhjb4gmel9dq .pp-logos-wrapper').addClass('pp-logos-wrapper-loaded');
				$('.fl-node-yhjb4gmel9dq .pp-logo').attr('role', 'group');

				var visibleCount = 0;
				$('.fl-node-yhjb4gmel9dq .pp-logo').each(function() {
				...
				$('.fl-node-yhjb4gmel9dq').off('keyup').on('keyup', function(e) {
					e.stopPropagation();
				...
				$(document).trigger( 'pp_logos_on_slider_load', [ $('.fl-node-yhjb4gmel9dq') ] );
			},
			onSlideBefore: function( ele, oldIndex, newIndex ) {
				this.stopAuto( true );
				$('.fl-node-yhjb4gmel9dq .logo-slider-nav').addClass('disabled');
				$('.fl-node-yhjb4gmel9dq .bx-controls .bx-pager-link').addClass('disabled');
								this.startAuto( true );
			...
			onSlideAfter: function( ele, oldIndex, newIndex ) {
				$('.fl-node-yhjb4gmel9dq .logo-slider-nav').removeClass('disabled');
				$('.fl-node-yhjb4gmel9dq .bx-controls .bx-pager-link').removeClass('disabled');
			}
		};
		...
		// Create the slider.
		var slider = $('.fl-node-yhjb4gmel9dq .pp-logos-wrapper').bxSlider( options );
