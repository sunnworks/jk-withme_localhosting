 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-rs7znogm1h9q .pp-heading-separator, .fl-node-rs7znogm1h9q .pp-heading').removeClass('pp-left');
        $('.fl-node-rs7znogm1h9q .pp-heading-separator, .fl-node-rs7znogm1h9q .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-rs7znogm1h9q .pp-heading-separator, .fl-node-rs7znogm1h9q .pp-heading').removeClass('pp-left');
        $('.fl-node-rs7znogm1h9q .pp-heading-separator, .fl-node-rs7znogm1h9q .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-kgftoadvujp6 .fl-photo-img' )
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-vhpfq8xrgn46 .pp-heading-separator, .fl-node-vhpfq8xrgn46 .pp-heading').removeClass('pp-left');
        $('.fl-node-vhpfq8xrgn46 .pp-heading-separator, .fl-node-vhpfq8xrgn46 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-vhpfq8xrgn46 .pp-heading-separator, .fl-node-vhpfq8xrgn46 .pp-heading').removeClass('pp-left');
        $('.fl-node-vhpfq8xrgn46 .pp-heading-separator, .fl-node-vhpfq8xrgn46 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_e7hxctblqgis'] = new PPAccordion({
			id: 'e7hxctblqgis',
			defaultItem: 1,
...
(function($) {
	...
	$(function() {
		...
		$('.fl-node-bkc2fo7rn9ms .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
		$('.fl-node-bkc2fo7rn9ms .pp-tabs-style-2 .pp-tabs-label').on('click', function() {
			$('.fl-node-bkc2fo7rn9ms .pp-tabs-style-2 .pp-tabs-label').removeClass('pp-no-border');
			$('.fl-node-bkc2fo7rn9ms .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
		});

		if($(window).width() > 768) {
			$('.fl-node-bkc2fo7rn9ms .pp-tabs-vertical .pp-tabs-panel-content').css('min-height', $('.fl-node-bkc2fo7rn9ms .pp-tabs-vertical .pp-tabs-labels').outerHeight() + 'px');
		}

		if( $(window).width() <= 768 ) {
			$('.fl-node-bkc2fo7rn9ms .pp-tabs-label .pp-tab-close').on('click', function() {
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-qvskibw63eh1 .pp-heading-separator, .fl-node-qvskibw63eh1 .pp-heading').removeClass('pp-center');
        $('.fl-node-qvskibw63eh1 .pp-heading-separator, .fl-node-qvskibw63eh1 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-qvskibw63eh1 .pp-heading-separator, .fl-node-qvskibw63eh1 .pp-heading').removeClass('pp-center');
        $('.fl-node-qvskibw63eh1 .pp-heading-separator, .fl-node-qvskibw63eh1 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-n0hew472xk1s .pp-heading-separator, .fl-node-n0hew472xk1s .pp-heading').removeClass('pp-left');
        $('.fl-node-n0hew472xk1s .pp-heading-separator, .fl-node-n0hew472xk1s .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-n0hew472xk1s .pp-heading-separator, .fl-node-n0hew472xk1s .pp-heading').removeClass('pp-left');
        $('.fl-node-n0hew472xk1s .pp-heading-separator, .fl-node-n0hew472xk1s .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-oil2r50hwusc .pp-heading-separator, .fl-node-oil2r50hwusc .pp-heading').removeClass('pp-left');
        $('.fl-node-oil2r50hwusc .pp-heading-separator, .fl-node-oil2r50hwusc .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-oil2r50hwusc .pp-heading-separator, .fl-node-oil2r50hwusc .pp-heading').removeClass('pp-left');
        $('.fl-node-oil2r50hwusc .pp-heading-separator, .fl-node-oil2r50hwusc .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-fpl1oqe6349w .pp-heading-separator, .fl-node-fpl1oqe6349w .pp-heading').removeClass('pp-center');
        $('.fl-node-fpl1oqe6349w .pp-heading-separator, .fl-node-fpl1oqe6349w .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-fpl1oqe6349w .pp-heading-separator, .fl-node-fpl1oqe6349w .pp-heading').removeClass('pp-center');
        $('.fl-node-fpl1oqe6349w .pp-heading-separator, .fl-node-fpl1oqe6349w .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-w1kae2vpix7m .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-k8el6zcgy3n9 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-r7q51iwd9l4x .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-0ey8r7cxi23w .pp-heading-separator, .fl-node-0ey8r7cxi23w .pp-heading').removeClass('pp-center');
        $('.fl-node-0ey8r7cxi23w .pp-heading-separator, .fl-node-0ey8r7cxi23w .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-0ey8r7cxi23w .pp-heading-separator, .fl-node-0ey8r7cxi23w .pp-heading').removeClass('pp-center');
        $('.fl-node-0ey8r7cxi23w .pp-heading-separator, .fl-node-0ey8r7cxi23w .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-y0q15fwr9emk .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-78n6e9axgfbh .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-78n6e9axgfbh .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-78n6e9axgfbh .pp-logos-wrapper').imagesLoaded(function() {
			// Clear the controls in case they were already created.
		//$('.fl-node-78n6e9axgfbh .logo-slider-next').empty();
		//$('.fl-node-78n6e9axgfbh .logo-slider-prev').empty();

		var getMinSlides = function() {
			var minSlides = ( $( window ).width() <= 768 ) ? parseInt( $( '.fl-node-78n6e9axgfbh' ).width() / 410) : 5;
		...
		var totalSlides = $('.fl-node-78n6e9axgfbh .pp-logo:not(.bx-clone)').length;
		...
		var options = {
			...
			onSliderLoad: function() {
				$('.fl-node-78n6e9axgfbh .pp-logos-wrapper').addClass('pp-logos-wrapper-loaded');
				$('.fl-node-78n6e9axgfbh .pp-logo').attr('role', 'group');

				var visibleCount = 0;
				$('.fl-node-78n6e9axgfbh .pp-logo').each(function() {
				...
				$('.fl-node-78n6e9axgfbh').off('keyup').on('keyup', function(e) {
					e.stopPropagation();
				...
				$(document).trigger( 'pp_logos_on_slider_load', [ $('.fl-node-78n6e9axgfbh') ] );
			},
			onSlideBefore: function( ele, oldIndex, newIndex ) {
				this.stopAuto( true );
				$('.fl-node-78n6e9axgfbh .logo-slider-nav').addClass('disabled');
				$('.fl-node-78n6e9axgfbh .bx-controls .bx-pager-link').addClass('disabled');
								this.startAuto( true );
			...
			onSlideAfter: function( ele, oldIndex, newIndex ) {
				$('.fl-node-78n6e9axgfbh .logo-slider-nav').removeClass('disabled');
				$('.fl-node-78n6e9axgfbh .bx-controls .bx-pager-link').removeClass('disabled');
			}
		};
		...
		// Create the slider.
		var slider = $('.fl-node-78n6e9axgfbh .pp-logos-wrapper').bxSlider( options );
