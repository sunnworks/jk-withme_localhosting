...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-sktghuw0n6yf .fl-photo-img' )
 ...
 */(function($) {
		...
		$('.fl-node-rm0ti2jel9h7 .pp-infobox').on('mouseenter', function() {
		$('.fl-node-rm0ti2jel9h7 .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-rm0ti2jel9h7 .pp-infobox').on('mouseleave', function() {
		$('.fl-node-rm0ti2jel9h7 .pp-icon-wrapper').removeClass(' none');
	});
 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-fjd06mxcn9ts .pp-heading-separator, .fl-node-fjd06mxcn9ts .pp-heading').removeClass('pp-left');
        $('.fl-node-fjd06mxcn9ts .pp-heading-separator, .fl-node-fjd06mxcn9ts .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-fjd06mxcn9ts .pp-heading-separator, .fl-node-fjd06mxcn9ts .pp-heading').removeClass('pp-left');
        $('.fl-node-fjd06mxcn9ts .pp-heading-separator, .fl-node-fjd06mxcn9ts .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-rz6qk4c57g9d .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
		...
		$('.fl-node-8ow30ehm7921 .pp-infobox').on('mouseenter', function() {
		$('.fl-node-8ow30ehm7921 .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-8ow30ehm7921 .pp-infobox').on('mouseleave', function() {
		$('.fl-node-8ow30ehm7921 .pp-icon-wrapper').removeClass(' none');
	});
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-e74zk2086hjw .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-cd36bmfxzkqe .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-mqjhtcg58fn0 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-habz058ie3gv .pp-heading-separator, .fl-node-habz058ie3gv .pp-heading').removeClass('pp-left');
        $('.fl-node-habz058ie3gv .pp-heading-separator, .fl-node-habz058ie3gv .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-habz058ie3gv .pp-heading-separator, .fl-node-habz058ie3gv .pp-heading').removeClass('pp-left');
        $('.fl-node-habz058ie3gv .pp-heading-separator, .fl-node-habz058ie3gv .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-6uk3b097oe5j .pp-heading-separator, .fl-node-6uk3b097oe5j .pp-heading').removeClass('pp-left');
        $('.fl-node-6uk3b097oe5j .pp-heading-separator, .fl-node-6uk3b097oe5j .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-6uk3b097oe5j .pp-heading-separator, .fl-node-6uk3b097oe5j .pp-heading').removeClass('pp-left');
        $('.fl-node-6uk3b097oe5j .pp-heading-separator, .fl-node-6uk3b097oe5j .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-udil258o1e6g .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
