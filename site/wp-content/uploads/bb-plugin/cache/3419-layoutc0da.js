 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-ogkc83qbspat .pp-heading-separator, .fl-node-ogkc83qbspat .pp-heading').removeClass('pp-center');
        $('.fl-node-ogkc83qbspat .pp-heading-separator, .fl-node-ogkc83qbspat .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-ogkc83qbspat .pp-heading-separator, .fl-node-ogkc83qbspat .pp-heading').removeClass('pp-center');
        $('.fl-node-ogkc83qbspat .pp-heading-separator, .fl-node-ogkc83qbspat .pp-heading').addClass('pp-mobile-');
    }
