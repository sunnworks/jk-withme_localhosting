 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-bd31ot2fp64c .pp-heading-separator, .fl-node-bd31ot2fp64c .pp-heading').removeClass('pp-center');
        $('.fl-node-bd31ot2fp64c .pp-heading-separator, .fl-node-bd31ot2fp64c .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-bd31ot2fp64c .pp-heading-separator, .fl-node-bd31ot2fp64c .pp-heading').removeClass('pp-center');
        $('.fl-node-bd31ot2fp64c .pp-heading-separator, .fl-node-bd31ot2fp64c .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-cmepz1uw07hq .fl-photo-img' )
 ...
 */(function($) {
		...
		$('.fl-node-052oamt8xs41 .pp-infobox').on('mouseenter', function() {
		$('.fl-node-052oamt8xs41 .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-052oamt8xs41 .pp-infobox').on('mouseleave', function() {
		$('.fl-node-052oamt8xs41 .pp-icon-wrapper').removeClass(' none');
	});

})(jQuery);
(function($) {

		$('.fl-node-jwgq546m3uxr .pp-infobox').on('mouseenter', function() {
		$('.fl-node-jwgq546m3uxr .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-jwgq546m3uxr .pp-infobox').on('mouseleave', function() {
		$('.fl-node-jwgq546m3uxr .pp-icon-wrapper').removeClass(' none');
	});

})(jQuery);
(function($) {

		$('.fl-node-7noa9v3xhe6k .pp-infobox').on('mouseenter', function() {
		$('.fl-node-7noa9v3xhe6k .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-7noa9v3xhe6k .pp-infobox').on('mouseleave', function() {
		$('.fl-node-7noa9v3xhe6k .pp-icon-wrapper').removeClass(' none');
	});
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-dwpy7vfjtab4 .pp-heading-separator, .fl-node-dwpy7vfjtab4 .pp-heading').removeClass('pp-left');
        $('.fl-node-dwpy7vfjtab4 .pp-heading-separator, .fl-node-dwpy7vfjtab4 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-dwpy7vfjtab4 .pp-heading-separator, .fl-node-dwpy7vfjtab4 .pp-heading').removeClass('pp-left');
        $('.fl-node-dwpy7vfjtab4 .pp-heading-separator, .fl-node-dwpy7vfjtab4 .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-ozcthjv79spq .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_i51jlcm2ryx7'] = new PPAccordion({
			id: 'i51jlcm2ryx7',
			defaultItem: 1,
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-y9l765bpojhn .pp-heading-separator, .fl-node-y9l765bpojhn .pp-heading').removeClass('pp-left');
        $('.fl-node-y9l765bpojhn .pp-heading-separator, .fl-node-y9l765bpojhn .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-y9l765bpojhn .pp-heading-separator, .fl-node-y9l765bpojhn .pp-heading').removeClass('pp-left');
        $('.fl-node-y9l765bpojhn .pp-heading-separator, .fl-node-y9l765bpojhn .pp-heading').addClass('pp-mobile-');
    }

})(jQuery);
(function($) {

		$('.fl-node-rxwl2ofuk06q .pp-infobox').on('mouseenter', function() {
		$('.fl-node-rxwl2ofuk06q .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-rxwl2ofuk06q .pp-infobox').on('mouseleave', function() {
		$('.fl-node-rxwl2ofuk06q .pp-icon-wrapper').removeClass(' none');
	});
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-dhw62f08q5c9 .pp-heading-separator, .fl-node-dhw62f08q5c9 .pp-heading').removeClass('pp-left');
        $('.fl-node-dhw62f08q5c9 .pp-heading-separator, .fl-node-dhw62f08q5c9 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-dhw62f08q5c9 .pp-heading-separator, .fl-node-dhw62f08q5c9 .pp-heading').removeClass('pp-left');
        $('.fl-node-dhw62f08q5c9 .pp-heading-separator, .fl-node-dhw62f08q5c9 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-78tk1c3mo5gd .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-78tk1c3mo5gd .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-78tk1c3mo5gd .pp-logos-wrapper').imagesLoaded(function() {
			// Clear the controls in case they were already created.
		//$('.fl-node-78tk1c3mo5gd .logo-slider-next').empty();
		//$('.fl-node-78tk1c3mo5gd .logo-slider-prev').empty();

		var getMinSlides = function() {
			var minSlides = ( $( window ).width() <= 768 ) ? parseInt( $( '.fl-node-78tk1c3mo5gd' ).width() / 262) : 4;
		...
		var totalSlides = $('.fl-node-78tk1c3mo5gd .pp-logo:not(.bx-clone)').length;
		...
		var options = {
			...
			ariaLive: false,
			onSliderLoad: function() {
				$('.fl-node-78tk1c3mo5gd .pp-logos-wrapper').addClass('pp-logos-wrapper-loaded');
				$('.fl-node-78tk1c3mo5gd .pp-logo').attr('role', 'group');

				var visibleCount = 0;
				$('.fl-node-78tk1c3mo5gd .pp-logo').each(function() {
					if ( ! $(this).hasClass( 'bx-clone' ) ) {
						visibleCount++;
						$(this).attr('aria-label', 'Slide ' + visibleCount + ' of ' + totalSlides );
					}
				...
				// Fix keyboard navigation
				var hasItemFocus = false;
				$('.fl-node-78tk1c3mo5gd').off('keyup').on('keyup', function(e) {
					e.stopPropagation();
					if ( $(e.target).hasClass('pp-logos-wrapper') || $(e.target).closest('.pp-logos-wrapper').length ) {
						hasItemFocus = true;
					}
				...
				$(document).trigger( 'pp_logos_on_slider_load', [ $('.fl-node-78tk1c3mo5gd') ] );
			},
			onSlideBefore: function( ele, oldIndex, newIndex ) {
				this.stopAuto( true );
				$('.fl-node-78tk1c3mo5gd .logo-slider-nav').addClass('disabled');
				$('.fl-node-78tk1c3mo5gd .bx-controls .bx-pager-link').addClass('disabled');
								this.startAuto( true );
			...
			onSlideAfter: function( ele, oldIndex, newIndex ) {
				$('.fl-node-78tk1c3mo5gd .logo-slider-nav').removeClass('disabled');
				$('.fl-node-78tk1c3mo5gd .bx-controls .bx-pager-link').removeClass('disabled');
			}
		};
		...
		// Create the slider.
		var slider = $('.fl-node-78tk1c3mo5gd .pp-logos-wrapper').bxSlider( options );
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-uxt5ai2f3rj4 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
