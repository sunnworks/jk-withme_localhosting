 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-cl98ugztnkxf .pp-heading-separator, .fl-node-cl98ugztnkxf .pp-heading').removeClass('pp-center');
        $('.fl-node-cl98ugztnkxf .pp-heading-separator, .fl-node-cl98ugztnkxf .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-cl98ugztnkxf .pp-heading-separator, .fl-node-cl98ugztnkxf .pp-heading').removeClass('pp-center');
        $('.fl-node-cl98ugztnkxf .pp-heading-separator, .fl-node-cl98ugztnkxf .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-8ph0woijzvcs .pp-heading-separator, .fl-node-8ph0woijzvcs .pp-heading').removeClass('pp-center');
        $('.fl-node-8ph0woijzvcs .pp-heading-separator, .fl-node-8ph0woijzvcs .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-8ph0woijzvcs .pp-heading-separator, .fl-node-8ph0woijzvcs .pp-heading').removeClass('pp-center');
        $('.fl-node-8ph0woijzvcs .pp-heading-separator, .fl-node-8ph0woijzvcs .pp-heading').addClass('pp-mobile-');
    }
...
})(jQuery);var carousel_hr39budcza6y = '';
...
(function($) {
	...
	carousel_hr39budcza6y = new PPImageCarousel(settings);

	function updateCarousel() {
		setTimeout(function() {
			if ( 'number' !== typeof carousel_hr39budcza6y.swipers.main.length ) {
				carousel_hr39budcza6y.swipers.main.update();
				if ( 'object' === typeof carousel_hr39budcza6y.swipers.thumbs ) {
					carousel_hr39budcza6y.swipers.thumbs.update();
				}
			} else {
				carousel_hr39budcza6y.swipers.main.forEach(function(item) {
	...
	$(document).on('pp_modal_box_rendered', function(e, selector) {
		if ( selector.find('.fl-node-hr39budcza6y').length > 0 ) {
			updateCarousel();
		}
	});
	
	$(document).on('fl-builder.pp-accordion-toggle-complete', function(e) {
		if ( $(e.target).find('.fl-node-hr39budcza6y').length > 0 ) {
			updateCarousel();
		}
	});
	...
	$('.fl-tabs').find('.fl-tabs-label').on('click', function() {
		...
		if ( panel.find('.fl-node-hr39budcza6y').length > 0 ) {
			updateCarousel();
		}
	});
	...
	$(document).on('pp_expandable_row_toggle', function(e, selector) {
		if ( selector.is('.pp-er-open') && state === 0 && selector.parent().find( '.fl-node-hr39budcza6y' ).length > 0 ) {
			updateCarousel();
			state = 1;
		}
	});
