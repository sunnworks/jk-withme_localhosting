 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-9he3da2f0zs6 .pp-heading-separator, .fl-node-9he3da2f0zs6 .pp-heading').removeClass('pp-left');
        $('.fl-node-9he3da2f0zs6 .pp-heading-separator, .fl-node-9he3da2f0zs6 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-9he3da2f0zs6 .pp-heading-separator, .fl-node-9he3da2f0zs6 .pp-heading').removeClass('pp-left');
        $('.fl-node-9he3da2f0zs6 .pp-heading-separator, .fl-node-9he3da2f0zs6 .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-yvlpj92ubxkr .fl-photo-img' )
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_zoqd8vb5lxag'] = new PPAccordion({
			id: 'zoqd8vb5lxag',
			defaultItem: 1,
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-hwj6irtlzk8y .pp-heading-separator, .fl-node-hwj6irtlzk8y .pp-heading').removeClass('pp-center');
        $('.fl-node-hwj6irtlzk8y .pp-heading-separator, .fl-node-hwj6irtlzk8y .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-hwj6irtlzk8y .pp-heading-separator, .fl-node-hwj6irtlzk8y .pp-heading').removeClass('pp-center');
        $('.fl-node-hwj6irtlzk8y .pp-heading-separator, .fl-node-hwj6irtlzk8y .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-6jhn3vpy1bi9 .pp-heading-separator, .fl-node-6jhn3vpy1bi9 .pp-heading').removeClass('pp-left');
        $('.fl-node-6jhn3vpy1bi9 .pp-heading-separator, .fl-node-6jhn3vpy1bi9 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-6jhn3vpy1bi9 .pp-heading-separator, .fl-node-6jhn3vpy1bi9 .pp-heading').removeClass('pp-left');
        $('.fl-node-6jhn3vpy1bi9 .pp-heading-separator, .fl-node-6jhn3vpy1bi9 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-zsh1pkn4y6u0 .pp-heading-separator, .fl-node-zsh1pkn4y6u0 .pp-heading').removeClass('pp-left');
        $('.fl-node-zsh1pkn4y6u0 .pp-heading-separator, .fl-node-zsh1pkn4y6u0 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-zsh1pkn4y6u0 .pp-heading-separator, .fl-node-zsh1pkn4y6u0 .pp-heading').removeClass('pp-left');
        $('.fl-node-zsh1pkn4y6u0 .pp-heading-separator, .fl-node-zsh1pkn4y6u0 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-nerp95fzd3qo .pp-heading-separator, .fl-node-nerp95fzd3qo .pp-heading').removeClass('pp-left');
        $('.fl-node-nerp95fzd3qo .pp-heading-separator, .fl-node-nerp95fzd3qo .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-nerp95fzd3qo .pp-heading-separator, .fl-node-nerp95fzd3qo .pp-heading').removeClass('pp-left');
        $('.fl-node-nerp95fzd3qo .pp-heading-separator, .fl-node-nerp95fzd3qo .pp-heading').addClass('pp-mobile-left');
    }
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-9d8gx5qfb637 .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 120) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 120;
			}
		});
		$('.fl-node-9d8gx5qfb637 .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-9d8gx5qfb637 .pp-logos-wrapper').imagesLoaded(function() {
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-kbeop14ydfhl .pp-heading-separator, .fl-node-kbeop14ydfhl .pp-heading').removeClass('pp-left');
        $('.fl-node-kbeop14ydfhl .pp-heading-separator, .fl-node-kbeop14ydfhl .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-kbeop14ydfhl .pp-heading-separator, .fl-node-kbeop14ydfhl .pp-heading').removeClass('pp-left');
        $('.fl-node-kbeop14ydfhl .pp-heading-separator, .fl-node-kbeop14ydfhl .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-c0x7zhes8pdk .pp-heading-separator, .fl-node-c0x7zhes8pdk .pp-heading').removeClass('pp-left');
        $('.fl-node-c0x7zhes8pdk .pp-heading-separator, .fl-node-c0x7zhes8pdk .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-c0x7zhes8pdk .pp-heading-separator, .fl-node-c0x7zhes8pdk .pp-heading').removeClass('pp-left');
        $('.fl-node-c0x7zhes8pdk .pp-heading-separator, .fl-node-c0x7zhes8pdk .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-pkzcy61bdoje .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-9hfdoxrm5bzs .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
