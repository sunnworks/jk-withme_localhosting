...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-wt6kscveryj7 .fl-photo-img' )
 ...
 */(function($) {
		...
		$('.fl-node-3nt0vdwjf2ys .pp-infobox').on('mouseenter', function() {
		$('.fl-node-3nt0vdwjf2ys .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-3nt0vdwjf2ys .pp-infobox').on('mouseleave', function() {
		$('.fl-node-3nt0vdwjf2ys .pp-icon-wrapper').removeClass(' none');
	});
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-m7sxdprcqgoa .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
		...
		$('.fl-node-g1wp7jnr5qm3 .pp-infobox').on('mouseenter', function() {
		$('.fl-node-g1wp7jnr5qm3 .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-g1wp7jnr5qm3 .pp-infobox').on('mouseleave', function() {
		$('.fl-node-g1wp7jnr5qm3 .pp-icon-wrapper').removeClass(' none');
	});

})(jQuery);
(function($) {

		$('.fl-node-9m2qgor5n7pu .pp-infobox').on('mouseenter', function() {
		$('.fl-node-9m2qgor5n7pu .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-9m2qgor5n7pu .pp-infobox').on('mouseleave', function() {
		$('.fl-node-9m2qgor5n7pu .pp-icon-wrapper').removeClass(' none');
	});
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-cndwqmi3jx6v .pp-heading-separator, .fl-node-cndwqmi3jx6v .pp-heading').removeClass('pp-left');
        $('.fl-node-cndwqmi3jx6v .pp-heading-separator, .fl-node-cndwqmi3jx6v .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-cndwqmi3jx6v .pp-heading-separator, .fl-node-cndwqmi3jx6v .pp-heading').removeClass('pp-left');
        $('.fl-node-cndwqmi3jx6v .pp-heading-separator, .fl-node-cndwqmi3jx6v .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-agenzmvs160f .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-nrpvof3gjkhz .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-5n0v7b1gm4ak .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-lad9p1iskhxw .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-vq5n461bw2ux .pp-heading-separator, .fl-node-vq5n461bw2ux .pp-heading').removeClass('pp-left');
        $('.fl-node-vq5n461bw2ux .pp-heading-separator, .fl-node-vq5n461bw2ux .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-vq5n461bw2ux .pp-heading-separator, .fl-node-vq5n461bw2ux .pp-heading').removeClass('pp-left');
        $('.fl-node-vq5n461bw2ux .pp-heading-separator, .fl-node-vq5n461bw2ux .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-ao5kevw2r4fi .pp-heading-separator, .fl-node-ao5kevw2r4fi .pp-heading').removeClass('pp-left');
        $('.fl-node-ao5kevw2r4fi .pp-heading-separator, .fl-node-ao5kevw2r4fi .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-ao5kevw2r4fi .pp-heading-separator, .fl-node-ao5kevw2r4fi .pp-heading').removeClass('pp-left');
        $('.fl-node-ao5kevw2r4fi .pp-heading-separator, .fl-node-ao5kevw2r4fi .pp-heading').addClass('pp-mobile-');
    }
