 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-itf6ygraz8bq .pp-heading-separator, .fl-node-itf6ygraz8bq .pp-heading').removeClass('pp-left');
        $('.fl-node-itf6ygraz8bq .pp-heading-separator, .fl-node-itf6ygraz8bq .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-itf6ygraz8bq .pp-heading-separator, .fl-node-itf6ygraz8bq .pp-heading').removeClass('pp-left');
        $('.fl-node-itf6ygraz8bq .pp-heading-separator, .fl-node-itf6ygraz8bq .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-2vdbcwoxzu4e .fl-photo-img' )
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_mc9i7rjd2s0o'] = new PPAccordion({
			id: 'mc9i7rjd2s0o',
			defaultItem: 1,
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-jgl6fmbet41r .pp-heading-separator, .fl-node-jgl6fmbet41r .pp-heading').removeClass('pp-center');
        $('.fl-node-jgl6fmbet41r .pp-heading-separator, .fl-node-jgl6fmbet41r .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-jgl6fmbet41r .pp-heading-separator, .fl-node-jgl6fmbet41r .pp-heading').removeClass('pp-center');
        $('.fl-node-jgl6fmbet41r .pp-heading-separator, .fl-node-jgl6fmbet41r .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-wyhqzsd0j2xo .pp-heading-separator, .fl-node-wyhqzsd0j2xo .pp-heading').removeClass('pp-left');
        $('.fl-node-wyhqzsd0j2xo .pp-heading-separator, .fl-node-wyhqzsd0j2xo .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-wyhqzsd0j2xo .pp-heading-separator, .fl-node-wyhqzsd0j2xo .pp-heading').removeClass('pp-left');
        $('.fl-node-wyhqzsd0j2xo .pp-heading-separator, .fl-node-wyhqzsd0j2xo .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-qguj9n7c0ov4 .pp-heading-separator, .fl-node-qguj9n7c0ov4 .pp-heading').removeClass('pp-left');
        $('.fl-node-qguj9n7c0ov4 .pp-heading-separator, .fl-node-qguj9n7c0ov4 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-qguj9n7c0ov4 .pp-heading-separator, .fl-node-qguj9n7c0ov4 .pp-heading').removeClass('pp-left');
        $('.fl-node-qguj9n7c0ov4 .pp-heading-separator, .fl-node-qguj9n7c0ov4 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-ol9tda7n6hg2 .pp-heading-separator, .fl-node-ol9tda7n6hg2 .pp-heading').removeClass('pp-left');
        $('.fl-node-ol9tda7n6hg2 .pp-heading-separator, .fl-node-ol9tda7n6hg2 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-ol9tda7n6hg2 .pp-heading-separator, .fl-node-ol9tda7n6hg2 .pp-heading').removeClass('pp-left');
        $('.fl-node-ol9tda7n6hg2 .pp-heading-separator, .fl-node-ol9tda7n6hg2 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-mdtqlxy1zoah .pp-heading-separator, .fl-node-mdtqlxy1zoah .pp-heading').removeClass('pp-left');
        $('.fl-node-mdtqlxy1zoah .pp-heading-separator, .fl-node-mdtqlxy1zoah .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-mdtqlxy1zoah .pp-heading-separator, .fl-node-mdtqlxy1zoah .pp-heading').removeClass('pp-left');
        $('.fl-node-mdtqlxy1zoah .pp-heading-separator, .fl-node-mdtqlxy1zoah .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-tdkslaw10uge .pp-heading-separator, .fl-node-tdkslaw10uge .pp-heading').removeClass('pp-');
        $('.fl-node-tdkslaw10uge .pp-heading-separator, .fl-node-tdkslaw10uge .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-tdkslaw10uge .pp-heading-separator, .fl-node-tdkslaw10uge .pp-heading').removeClass('pp-');
        $('.fl-node-tdkslaw10uge .pp-heading-separator, .fl-node-tdkslaw10uge .pp-heading').addClass('pp-mobile-left');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-em7jifz3n8o0 .pp-heading-separator, .fl-node-em7jifz3n8o0 .pp-heading').removeClass('pp-left');
        $('.fl-node-em7jifz3n8o0 .pp-heading-separator, .fl-node-em7jifz3n8o0 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-em7jifz3n8o0 .pp-heading-separator, .fl-node-em7jifz3n8o0 .pp-heading').removeClass('pp-left');
        $('.fl-node-em7jifz3n8o0 .pp-heading-separator, .fl-node-em7jifz3n8o0 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-t2cgzj6kqn8s .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-t2cgzj6kqn8s .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-t2cgzj6kqn8s .pp-logos-wrapper').imagesLoaded(function() {
			// Clear the controls in case they were already created.
		//$('.fl-node-t2cgzj6kqn8s .logo-slider-next').empty();
		//$('.fl-node-t2cgzj6kqn8s .logo-slider-prev').empty();

		var getMinSlides = function() {
			var minSlides = ( $( window ).width() <= 768 ) ? parseInt( $( '.fl-node-t2cgzj6kqn8s' ).width() / 270) : 3;
		...
		var totalSlides = $('.fl-node-t2cgzj6kqn8s .pp-logo:not(.bx-clone)').length;
		...
		var options = {
			...
			onSliderLoad: function() {
				$('.fl-node-t2cgzj6kqn8s .pp-logos-wrapper').addClass('pp-logos-wrapper-loaded');
				$('.fl-node-t2cgzj6kqn8s .pp-logo').attr('role', 'group');

				var visibleCount = 0;
				$('.fl-node-t2cgzj6kqn8s .pp-logo').each(function() {
				...
				$('.fl-node-t2cgzj6kqn8s').off('keyup').on('keyup', function(e) {
					e.stopPropagation();
				...
				$(document).trigger( 'pp_logos_on_slider_load', [ $('.fl-node-t2cgzj6kqn8s') ] );
			},
			onSlideBefore: function( ele, oldIndex, newIndex ) {
				this.stopAuto( true );
				$('.fl-node-t2cgzj6kqn8s .logo-slider-nav').addClass('disabled');
				$('.fl-node-t2cgzj6kqn8s .bx-controls .bx-pager-link').addClass('disabled');
								this.startAuto( true );
			...
			onSlideAfter: function( ele, oldIndex, newIndex ) {
				$('.fl-node-t2cgzj6kqn8s .logo-slider-nav').removeClass('disabled');
				$('.fl-node-t2cgzj6kqn8s .bx-controls .bx-pager-link').removeClass('disabled');
			}
		};
		...
		// Create the slider.
		var slider = $('.fl-node-t2cgzj6kqn8s .pp-logos-wrapper').bxSlider( options );
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-4xyr5792k6ml .pp-heading-separator, .fl-node-4xyr5792k6ml .pp-heading').removeClass('pp-left');
        $('.fl-node-4xyr5792k6ml .pp-heading-separator, .fl-node-4xyr5792k6ml .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-4xyr5792k6ml .pp-heading-separator, .fl-node-4xyr5792k6ml .pp-heading').removeClass('pp-left');
        $('.fl-node-4xyr5792k6ml .pp-heading-separator, .fl-node-4xyr5792k6ml .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-khf8vbxdm0nc .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-v95syg7lkfju .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-v95syg7lkfju .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-v95syg7lkfju .pp-logos-wrapper').imagesLoaded(function() {
