...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-71lxdbc9fka6 .fl-photo-img' )
 ...
 */(function($) {
		...
		$('.fl-node-p6vkfxtb4a0z .pp-infobox').on('mouseenter', function() {
		$('.fl-node-p6vkfxtb4a0z .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-p6vkfxtb4a0z .pp-infobox').on('mouseleave', function() {
		$('.fl-node-p6vkfxtb4a0z .pp-icon-wrapper').removeClass(' none');
	});

})(jQuery);
(function($) {

		$('.fl-node-7qsjkp5v43x9 .pp-infobox').on('mouseenter', function() {
		$('.fl-node-7qsjkp5v43x9 .pp-icon-wrapper').addClass(' none');
	});
	$('.fl-node-7qsjkp5v43x9 .pp-infobox').on('mouseleave', function() {
		$('.fl-node-7qsjkp5v43x9 .pp-icon-wrapper').removeClass(' none');
	});
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-9mha4bjg6okx .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-fbxuztcdeloj .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
