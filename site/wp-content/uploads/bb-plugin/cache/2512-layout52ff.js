 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-gn0csd8p1a4y .pp-heading-separator, .fl-node-gn0csd8p1a4y .pp-heading').removeClass('pp-left');
        $('.fl-node-gn0csd8p1a4y .pp-heading-separator, .fl-node-gn0csd8p1a4y .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-gn0csd8p1a4y .pp-heading-separator, .fl-node-gn0csd8p1a4y .pp-heading').removeClass('pp-left');
        $('.fl-node-gn0csd8p1a4y .pp-heading-separator, .fl-node-gn0csd8p1a4y .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-qx1svrn5h6op .fl-photo-img' )
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-r81qsy45z7bi .pp-heading-separator, .fl-node-r81qsy45z7bi .pp-heading').removeClass('pp-center');
        $('.fl-node-r81qsy45z7bi .pp-heading-separator, .fl-node-r81qsy45z7bi .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-r81qsy45z7bi .pp-heading-separator, .fl-node-r81qsy45z7bi .pp-heading').removeClass('pp-center');
        $('.fl-node-r81qsy45z7bi .pp-heading-separator, .fl-node-r81qsy45z7bi .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_qz01vth284ln'] = new PPAccordion({
			id: 'qz01vth284ln',
			defaultItem: 1,
...
(function($) {
	...
	$(function() {
		...
		$('.fl-node-tdx0v9uw27y6 .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
		$('.fl-node-tdx0v9uw27y6 .pp-tabs-style-2 .pp-tabs-label').on('click', function() {
			$('.fl-node-tdx0v9uw27y6 .pp-tabs-style-2 .pp-tabs-label').removeClass('pp-no-border');
			$('.fl-node-tdx0v9uw27y6 .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
		});

		if($(window).width() > 768) {
			$('.fl-node-tdx0v9uw27y6 .pp-tabs-vertical .pp-tabs-panel-content').css('min-height', $('.fl-node-tdx0v9uw27y6 .pp-tabs-vertical .pp-tabs-labels').outerHeight() + 'px');
		}

		if( $(window).width() <= 768 ) {
			$('.fl-node-tdx0v9uw27y6 .pp-tabs-label .pp-tab-close').on('click', function() {
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-wnx8kbpzim7r .pp-heading-separator, .fl-node-wnx8kbpzim7r .pp-heading').removeClass('pp-center');
        $('.fl-node-wnx8kbpzim7r .pp-heading-separator, .fl-node-wnx8kbpzim7r .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-wnx8kbpzim7r .pp-heading-separator, .fl-node-wnx8kbpzim7r .pp-heading').removeClass('pp-center');
        $('.fl-node-wnx8kbpzim7r .pp-heading-separator, .fl-node-wnx8kbpzim7r .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-2n39cqymitkv .pp-heading-separator, .fl-node-2n39cqymitkv .pp-heading').removeClass('pp-left');
        $('.fl-node-2n39cqymitkv .pp-heading-separator, .fl-node-2n39cqymitkv .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-2n39cqymitkv .pp-heading-separator, .fl-node-2n39cqymitkv .pp-heading').removeClass('pp-left');
        $('.fl-node-2n39cqymitkv .pp-heading-separator, .fl-node-2n39cqymitkv .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-n4wal5cz03u9 .pp-heading-separator, .fl-node-n4wal5cz03u9 .pp-heading').removeClass('pp-left');
        $('.fl-node-n4wal5cz03u9 .pp-heading-separator, .fl-node-n4wal5cz03u9 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-n4wal5cz03u9 .pp-heading-separator, .fl-node-n4wal5cz03u9 .pp-heading').removeClass('pp-left');
        $('.fl-node-n4wal5cz03u9 .pp-heading-separator, .fl-node-n4wal5cz03u9 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-iocujzg7vfm1 .pp-heading-separator, .fl-node-iocujzg7vfm1 .pp-heading').removeClass('pp-');
        $('.fl-node-iocujzg7vfm1 .pp-heading-separator, .fl-node-iocujzg7vfm1 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-iocujzg7vfm1 .pp-heading-separator, .fl-node-iocujzg7vfm1 .pp-heading').removeClass('pp-');
        $('.fl-node-iocujzg7vfm1 .pp-heading-separator, .fl-node-iocujzg7vfm1 .pp-heading').addClass('pp-mobile-left');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-al6fp9sc5rh7 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-9risjgy50etf .pp-heading-separator, .fl-node-9risjgy50etf .pp-heading').removeClass('pp-left');
        $('.fl-node-9risjgy50etf .pp-heading-separator, .fl-node-9risjgy50etf .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-9risjgy50etf .pp-heading-separator, .fl-node-9risjgy50etf .pp-heading').removeClass('pp-left');
        $('.fl-node-9risjgy50etf .pp-heading-separator, .fl-node-9risjgy50etf .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-p7y0irmehlst .pp-heading-separator, .fl-node-p7y0irmehlst .pp-heading').removeClass('pp-left');
        $('.fl-node-p7y0irmehlst .pp-heading-separator, .fl-node-p7y0irmehlst .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-p7y0irmehlst .pp-heading-separator, .fl-node-p7y0irmehlst .pp-heading').removeClass('pp-left');
        $('.fl-node-p7y0irmehlst .pp-heading-separator, .fl-node-p7y0irmehlst .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-dnorcu5slm96 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
