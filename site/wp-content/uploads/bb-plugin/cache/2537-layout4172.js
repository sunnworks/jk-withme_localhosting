 ...
 */(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-vsfq5n6d9wia .pp-heading-separator, .fl-node-vsfq5n6d9wia .pp-heading').removeClass('pp-left');
        $('.fl-node-vsfq5n6d9wia .pp-heading-separator, .fl-node-vsfq5n6d9wia .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-vsfq5n6d9wia .pp-heading-separator, .fl-node-vsfq5n6d9wia .pp-heading').removeClass('pp-left');
        $('.fl-node-vsfq5n6d9wia .pp-heading-separator, .fl-node-vsfq5n6d9wia .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-rz9lo4iwtgp3 .fl-photo-img' )
...
(function($) {
	...
	$(function() {
		...
		window['pp_accordion_0yvelzo5nw1f'] = new PPAccordion({
			id: '0yvelzo5nw1f',
			defaultItem: 1,
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-uycrt7i0hag1 .pp-heading-separator, .fl-node-uycrt7i0hag1 .pp-heading').removeClass('pp-center');
        $('.fl-node-uycrt7i0hag1 .pp-heading-separator, .fl-node-uycrt7i0hag1 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-uycrt7i0hag1 .pp-heading-separator, .fl-node-uycrt7i0hag1 .pp-heading').removeClass('pp-center');
        $('.fl-node-uycrt7i0hag1 .pp-heading-separator, .fl-node-uycrt7i0hag1 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-mrbz8hce0i59 .pp-heading-separator, .fl-node-mrbz8hce0i59 .pp-heading').removeClass('pp-left');
        $('.fl-node-mrbz8hce0i59 .pp-heading-separator, .fl-node-mrbz8hce0i59 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-mrbz8hce0i59 .pp-heading-separator, .fl-node-mrbz8hce0i59 .pp-heading').removeClass('pp-left');
        $('.fl-node-mrbz8hce0i59 .pp-heading-separator, .fl-node-mrbz8hce0i59 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-eny10rlq5pia .pp-heading-separator, .fl-node-eny10rlq5pia .pp-heading').removeClass('pp-left');
        $('.fl-node-eny10rlq5pia .pp-heading-separator, .fl-node-eny10rlq5pia .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-eny10rlq5pia .pp-heading-separator, .fl-node-eny10rlq5pia .pp-heading').removeClass('pp-left');
        $('.fl-node-eny10rlq5pia .pp-heading-separator, .fl-node-eny10rlq5pia .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-bxp7j94me6q1 .pp-heading-separator, .fl-node-bxp7j94me6q1 .pp-heading').removeClass('pp-left');
        $('.fl-node-bxp7j94me6q1 .pp-heading-separator, .fl-node-bxp7j94me6q1 .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-bxp7j94me6q1 .pp-heading-separator, .fl-node-bxp7j94me6q1 .pp-heading').removeClass('pp-left');
        $('.fl-node-bxp7j94me6q1 .pp-heading-separator, .fl-node-bxp7j94me6q1 .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-x8yzcvq6h3rm .pp-heading-separator, .fl-node-x8yzcvq6h3rm .pp-heading').removeClass('pp-left');
        $('.fl-node-x8yzcvq6h3rm .pp-heading-separator, .fl-node-x8yzcvq6h3rm .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-x8yzcvq6h3rm .pp-heading-separator, .fl-node-x8yzcvq6h3rm .pp-heading').removeClass('pp-left');
        $('.fl-node-x8yzcvq6h3rm .pp-heading-separator, .fl-node-x8yzcvq6h3rm .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-rh9oyp61ujin .pp-heading-separator, .fl-node-rh9oyp61ujin .pp-heading').removeClass('pp-');
        $('.fl-node-rh9oyp61ujin .pp-heading-separator, .fl-node-rh9oyp61ujin .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-rh9oyp61ujin .pp-heading-separator, .fl-node-rh9oyp61ujin .pp-heading').removeClass('pp-');
        $('.fl-node-rh9oyp61ujin .pp-heading-separator, .fl-node-rh9oyp61ujin .pp-heading').addClass('pp-mobile-left');
    }
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-pj3iyotc8snr .pp-heading-separator, .fl-node-pj3iyotc8snr .pp-heading').removeClass('pp-left');
        $('.fl-node-pj3iyotc8snr .pp-heading-separator, .fl-node-pj3iyotc8snr .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-pj3iyotc8snr .pp-heading-separator, .fl-node-pj3iyotc8snr .pp-heading').removeClass('pp-left');
        $('.fl-node-pj3iyotc8snr .pp-heading-separator, .fl-node-pj3iyotc8snr .pp-heading').addClass('pp-mobile-');
    }
...
(function($) {
	...
	function equalheight() {
		...
		var maxHeight = 0;
		$('.fl-node-j3n9rbcqgofm .pp-logos-wrapper .pp-logo').each(function(index) {
			if(($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
				maxHeight = $(this).find('.logo-image').outerHeight() + 0;
			}
		});
		$('.fl-node-j3n9rbcqgofm .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');

				return maxHeight;
	}

	$('.fl-node-j3n9rbcqgofm .pp-logos-wrapper').imagesLoaded(function() {
...
(function($) {
    ...
    if($(window).width() <= 768 && $(window).width() >= 481 ) {
        $('.fl-node-aw15vor2l6ec .pp-heading-separator, .fl-node-aw15vor2l6ec .pp-heading').removeClass('pp-left');
        $('.fl-node-aw15vor2l6ec .pp-heading-separator, .fl-node-aw15vor2l6ec .pp-heading').addClass('pp-tablet-');
    }

    if( $(window).width() <= 480 ) {
        $('.fl-node-aw15vor2l6ec .pp-heading-separator, .fl-node-aw15vor2l6ec .pp-heading').removeClass('pp-left');
        $('.fl-node-aw15vor2l6ec .pp-heading-separator, .fl-node-aw15vor2l6ec .pp-heading').addClass('pp-mobile-');
    }
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-0x5vz3t64jnu .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
